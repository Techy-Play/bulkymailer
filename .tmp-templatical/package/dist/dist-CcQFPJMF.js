...
}, oe = Object.create(null), C = class e {
...
function he(e, t) {
	let n = me(e), r = n;
	return e.eat(",") && (r = e.next == "}" ? -1 : me(e)), e.eat("}") || e.err("Unclosed braced range"), {
		type: "range",
		min: n,
		max: r,
		expr: t
...
function _e(e) {
	...
	if (/\W/.test(e.next)) e.err("Unexpected token '" + e.next + "'");
		...
		let t = ge(e, e.next).map((t) => (e.inline == null ? e.inline = t.isInline : e.inline != t.isInline && e.err("Mixing inline and block content"), {
			type: "name",
			value: t
		}));
...
function xe(e) {
	...
	function n(r) {
		...
		let a = t[r.join(",")] = new le(r.indexOf(e.length - 1) > -1);
		for (let e = 0; e < i.length; e++) {
			let r = i[e][1].sort(ye);
			a.next.push({
				type: i[e][0],
...
var De = class e {
	constructor(e, t, n) {
		this.name = e, this.schema = t, this.spec = n, this.markSet = null, this.groups = n.group ? n.group.split(" ") : [], this.attrs = Ee(e, n.attrs), this.defaultAttrs = Ce(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(n.inline || e == "text"), this.isText = e == "text";
	}
	get isInline() {
		return !this.isBlock;
	}
	...
	computeAttrs(e) {
		return !e && this.defaultAttrs ? this.defaultAttrs : we(this.attrs, e);
	}
	create(e = null, t, n) {
		if (this.isText) throw Error("NodeType.create can't construct text nodes");
		return new C(this, this.computeAttrs(e), a.from(t), l.setFrom(n));
	}
	createChecked(e = null, t, n) {
		return t = a.from(t), this.checkContent(t), new C(this, this.computeAttrs(e), t, l.setFrom(n));
	}
	createAndFill(e = null, t, n) {
		...
		return i ? new C(this, e, t.append(i), l.setFrom(n)) : null;
	}
	validContent(e) {
	...
	checkAttrs(e) {
		Te(this.attrs, e, "node", this.name);
	}
	allowsMarkType(e) {
...
var ke = class {
	constructor(e, t, n) {
		this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default"), this.default = n.default, this.validate = typeof n.validate == "string" ? Oe(e, t, n.validate) : n.validate;
	}
	get isRequired() {
	...
	constructor(e, t, n, r) {
		this.name = e, this.rank = t, this.schema = n, this.spec = r, this.attrs = Ee(e, r.attrs), this.excluded = null;
		let i = Ce(this.attrs);
		this.instance = i ? new l(this, i) : null;
	}
	create(e = null) {
		return !e && this.instance ? this.instance : new l(this, we(this.attrs, e));
	}
	static compile(t, n) {
	...
	checkAttrs(e) {
		Te(this.attrs, e, "mark", this.name);
	}
	excludes(e) {
	...
	constructor(t) {
		...
		n.nodes = e.from(t.nodes), n.marks = e.from(t.marks || {}), this.nodes = De.compile(this.spec.nodes, this), this.marks = Ae.compile(this.spec.marks, this);
		let r = Object.create(null);
		for (let e in this.nodes) {
			...
			if (t.contentMatch = r[n] || (r[n] = le.parse(n, this.nodes)), t.inlineContent = t.contentMatch.inlineContent, t.spec.linebreakReplacement) {
			...
			t.markSet = i == "_" ? null : i ? Me(this, i.split(" ")) : i == "" || !t.inlineContent ? [] : null;
		}
		for (let e in this.marks) {
			let t = this.marks[e], n = t.spec.excludes;
			t.excluded = n == null ? [t] : n == "" ? [] : Me(this, n.split(" "));
		}
		this.nodeFromJSON = (e) => C.fromJSON(this, e), this.markFromJSON = (e) => l.fromJSON(this, e), this.topNodeType = this.nodes[this.spec.topNode || "doc"], this.cached.wrappings = Object.create(null);
	}
	node(e, t = null, n, r) {
	...
	text(e, t) {
		...
		return new se(n, n.defaultAttrs, e, l.setFrom(t));
	}
	mark(e, t) {
...
function He(e, t, n) {
	return t == null ? e && e.whitespace == "pre" ? 3 : n & -5 : (t ? ze : 0) | (t === "full" ? Be : 0);
}
var Ue = class {
	constructor(e, t, n, r, i, a) {
		this.type = e, this.attrs = t, this.marks = n, this.solid = r, this.options = a, this.content = [], this.activeMarks = l.none, this.match = i || (a & Ve ? null : e.contentMatch);
	}
	findWrapping(e) {
		if (!this.match) {
			if (!this.type) return [];
	...
	inlineContext(e) {
		return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !Ie.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
	}
}, We = class {
	constructor(e, t, n) {
		this.parser = e, this.options = t, this.isOpen = n, this.open = 0, this.localPreserveWS = !1;
		let r = t.topNode, i, a = He(null, t.preserveWhitespace, 0) | (n ? Ve : 0);
		i = r ? new Ue(r.type, r.attrs, l.none, !0, t.topMatch || r.type.contentMatch, a) : n ? new Ue(null, null, l.none, !0, null, a) : new Ue(e.schema.topNodeType, null, l.none, !0, null, a), this.nodes = [i], this.find = t.findPositions, this.needsBlock = !1;
	}
	get top() {
	...
	addTextNode(e, t) {
		let n = e.nodeValue, r = this.top, i = r.options & Be ? "full" : this.localPreserveWS || (r.options & ze) > 0, { schema: a } = this.parser;
	...
	addElement(e, t, n) {
		...
		Re.hasOwnProperty(a) && this.parser.normalizeLists && Ge(e);
		let s = this.options.ruleFromNode && this.options.ruleFromNode(e) || (o = this.parser.matchTag(e, this, n));
		out: if (s ? s.ignore : Le.hasOwnProperty(a)) this.findInside(e), this.ignoreFallback(e, t);
		else if (!s || s.skip || s.closeParent) {
			s && s.closeParent ? this.open = Math.max(0, this.open - 1) : s && s.skip.nodeType && (e = s.skip);
			let n, r = this.needsBlock;
			if (Ie.hasOwnProperty(a)) i.content.length && i.content[0].isInline && this.open && (this.open--, i = this.top), n = !0, i.type || (this.needsBlock = !0);
	...
	insertNode(e, t, n) {
		...
		if (r) {
			...
			let n = l.none;
			for (let i of r.concat(e.marks)) (t.type ? t.type.allowsMarkType(i.type) : Je(i.type, e.type)) && (n = i.addToSet(n));
	...
	enterInner(e, t, n, r = !1, i) {
		...
		let o = He(e, i, a.options);
		a.options & Ve && a.content.length == 0 && (o |= Ve);
		let s = l.none;
		return n = n.filter((t) => !(a.type ? a.type.allowsMarkType(t.type) : Je(t.type, e)) || (s = t.addToSet(s), !1)), this.nodes.push(new Ue(e, t, s, r, null, o)), this.open++, n;
	}
	closeExtra(e = !1) {
	...
	sync(e) {
		...
		else this.localPreserveWS && (this.nodes[t].options |= ze);
		return !1;
	}
	get currentPos() {
		this.closeExtra();
...
function Ge(e) {
	for (let t = e.firstChild, n = null; t; t = t.nextSibling) {
		...
		e && Re.hasOwnProperty(e) && n ? (n.appendChild(t), t = n) : e == "li" ? n = t : e && (n = null);
	}
}
function Ke(e, t) {
...
var Ye = class e {
	...
	serializeNodeInner(e, t) {
		if (e.isText) return Ze(t).createTextNode(e.text);
		let { dom: n, contentDOM: r } = tt(Ze(t), this.nodes[e.type.name](e), null, e.attrs);
		if (r) {
	...
	serializeMark(e, t, n = {}) {
		...
		return r && tt(Ze(n), r(e, t), null, e.attrs);
	}
...
function $e(e) {
	let t = Qe.get(e);
	return t === void 0 && Qe.set(e, t = et(e)), t;
}
function et(e) {
	let t = null;
	function n(e) {
...
function tt(e, t, n, r) {
	...
	if (r && (a = $e(r)) && a.indexOf(t) > -1) throw RangeError("Using an array from an attribute object as a DOM spec. This may be an attempted cross site scripting attack.");
	let o = i.indexOf(" ");
...
var st = 1, ct = 2, lt = 4, ut = 8, dt = class {
	constructor(e, t, n) {
	...
	_map(e, t, n) {
		...
		for (let o = 0; o < this.ranges.length; o += 3) {
			...
			if (e <= u) {
				...
				if (n) return a;
				let d = e == (t < 0 ? s : u) ? null : it(o / 3, e - s), f = e == s ? ct : e == u ? st : lt;
				return (t < 0 ? e != s : e != u) && (f |= ut), new dt(a, f, d);
			}
			r += l - c;
		}
	...
	touches(e, t) {
		let n = 0, r = at(t), i = this.inverted ? 2 : 1, a = this.inverted ? 1 : 2;
...
var pt = class e {
	...
	static jsonID(e, t) {
		if (e in mt) throw RangeError("Duplicate use of step JSON ID " + e);
...
w.jsonID("removeNodeMark", yt);
var E = class e extends w {
	constructor(e, t, n, r = !1) {
		super(), this.from = e, this.to = t, this.slice = n, this.structure = r;
	}
	apply(e) {
		return this.structure && bt(e, this.from, this.to) ? T.fail("Structure replace would overwrite content") : T.fromReplace(e, this.from, this.to, this.slice);
	}
	getMap() {
		return new ft([
			this.from,
...
E.MAP_BIAS = 1, w.jsonID("replace", E);
var D = class e extends w {
	...
	apply(e) {
		if (this.structure && (bt(e, this.from, this.gapFrom) || bt(e, this.gapTo, this.to))) return T.fail("Structure gap-replace would overwrite content");
...
function xt(e, t, n, r) {
	...
	e.doc.nodesBetween(t, n, (e, c, l) => {
		...
		if (!r.isInSet(u) && l.type.allowsMarkType(r.type)) {
			...
			for (let e = 0; e < u.length; e++) u[e].isInSet(f) || (o && o.to == l && o.mark.eq(u[e]) ? o.to = d : i.push(o = new _t(l, d, u[e])));
			s && s.to == l ? s.to = d : a.push(s = new gt(l, d, r));
		}
...
function St(e, t, n, r) {
	...
	}), i.forEach((t) => e.step(new _t(t.from, t.to, t.style)));
}
function Ct(e, t, n, r = n.contentMatch, i = !0) {
	let o = e.doc.nodeAt(t), s = [], c = t + 1;
	for (let t = 0; t < o.childCount; t++) {
		let l = o.child(t), u = c + l.nodeSize, f = r.matchType(l.type);
		if (!f) s.push(new E(c, u, d.empty));
		else {
			r = f;
			for (let t = 0; t < l.marks.length; t++) n.allowsMarkType(l.marks[t].type) || e.step(new _t(c, u, l.marks[t]));
			if (i && l.isText && n.whitespace != "pre") {
				let e, t = /\r?\n|\r/g, r;
				for (; e = t.exec(l.text);) r ||= new d(a.from(n.schema.text(" ", n.allowedMarks(l.marks))), 0, 0), s.push(new E(c + e.index, c + e.index + e[0].length, r));
			}
		}
		c = u;
	}
...
function Et(e, t, n) {
	...
	e.step(new D(l, u, s, c, new d(f.append(m), p, h), f.size - p, !0));
}
function Dt(e, t, n = null, r = e) {
	let i = kt(e, t), a = i && At(r, t);
	return a ? i.map(Ot).concat({
		type: t,
		attrs: n
	}).concat(a.map(Ot)) : null;
}
function Ot(e) {
	return {
		type: e,
...
function jt(e, t, n) {
	...
	e.step(new D(i, o, i, o, new d(r, 0, 0), n.length, !0));
}
function Mt(e, t, n, r, i) {
	...
	e.doc.nodesBetween(t, n, (t, n) => {
		...
		if (t.isTextblock && !t.hasMarkup(r, s) && Ft(e.doc, e.mapping.slice(o).map(n), r)) {
			...
			i === !1 && Pt(e, t, n, o), Ct(e, e.mapping.slice(o).map(n, 1), r, void 0, i === null);
			let c = e.mapping.slice(o), l = c.map(n, 1), u = c.map(n + t.nodeSize, 1);
			return e.step(new D(l, u, l + 1, u - 1, new d(a.from(r.create(s, null, t.marks)), 0, 0), 1, !0)), i === !0 && Nt(e, t, n, o), !1;
		}
	});
}
function Nt(e, t, n, r) {
...
function It(e, t, n, r, i) {
	...
	e.step(new D(t, t + o.nodeSize, t + 1, t + o.nodeSize - 1, new d(a.from(s), 0, 0), 1, !0));
}
...
function Rt(e, t, n = 1, r) {
	...
	e.step(new E(t, t, new d(o.append(s), n, n), !0));
}
function zt(e, t) {
...
function Ht(e, t, n = -1) {
	...
	for (let e = r.depth;; e--) {
		let i, a, o = r.index(e);
		if (e == r.depth ? (i = r.nodeBefore, a = r.nodeAfter) : n > 0 ? (i = r.node(e + 1), o++, a = r.node(e).maybeChild(o)) : (i = r.node(e).maybeChild(o - 1), a = r.node(e + 1)), i && !i.isTextblock && Vt(i, a) && r.node(e).canReplace(o, o + 1)) return t;
		if (e == 0) break;
...
function Ut(e, t, n) {
	...
	o.inlineContent && Ct(e, t + n - 1, o, a.node().contentMatchAt(a.index()), r == null);
	let c = e.mapping.slice(s), l = c.map(t - n);
	if (e.step(new E(l, c.map(t + n, -1), d.empty, !0)), r === !0) {
...
function Kt(e, t, n = t, r = d.empty) {
	if (t == n && !r.size) return null;
	let i = e.resolve(t), a = e.resolve(n);
	return qt(i, a, r) ? new E(t, n, r) : new Jt(i, a, r).fit();
}
function qt(e, t, n) {
...
var Jt = class {
	...
	fit() {
		...
		let s = new d(i, a, o);
		return e > -1 ? new D(n.pos, e, this.$to.pos, this.$to.end(), s, t) : s.size || n.pos != this.$to.pos ? new E(n.pos, r.pos, s) : null;
	}
	findFittable() {
		...
		for (let t = 1; t <= 2; t++) for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
			let e, r = null;
			n ? (r = Zt(this.unplaced.content, n - 1).firstChild, e = r.content) : e = this.unplaced.content;
			let i = e.firstChild;
	...
	openMore() {
		let { content: e, openStart: t, openEnd: n } = this.unplaced, r = Zt(e, t);
	...
	dropNode() {
		...
		if (r.childCount <= 1 && t > 0) {
			...
			this.unplaced = new d(Yt(e, t - 1, 1), t - 1, i ? t - 1 : n);
		} else this.unplaced = new d(Yt(e, t, 1), t, n);
	}
	placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: i }) {
		...
		h || (m = -1), this.placed = Xt(this.placed, t, a.from(u)), this.frontier[t].match = f, h && m < 0 && n && n.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
		...
		this.unplaced = h ? e == 0 ? d.empty : new d(Yt(o.content, e - 1, 1), e - 1, m < 0 ? o.openEnd : e - 1) : new d(Yt(o.content, e, l), o.openStart, o.openEnd);
	}
	mustMoveInline() {
	...
	findCloseLevel(e) {
		scan: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
			let { match: n, type: r } = this.frontier[t], i = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), a = $t(e, t, r, n, i);
			if (a) {
				for (let n = t - 1; n >= 0; n--) {
					let { match: t, type: r } = this.frontier[n], i = $t(e, n, r, t, !0);
	...
	openFrontierNode(e, t = null, n) {
		...
		r.match = r.match.matchType(e), this.placed = Xt(this.placed, this.depth, a.from(e.create(t, n))), this.frontier.push({
			type: e,
	...
	closeFrontierNode() {
		...
		e.childCount && (this.placed = Xt(this.placed, this.frontier.length, e));
	}
};
function Yt(e, t, n) {
	return t == 0 ? e.cutByIndex(n, e.childCount) : e.replaceChild(0, e.firstChild.copy(Yt(e.firstChild.content, t - 1, n)));
}
function Xt(e, t, n) {
	return t == 0 ? e.append(n) : e.replaceChild(e.childCount - 1, e.lastChild.copy(Xt(e.lastChild.content, t - 1, n)));
}
function Zt(e, t) {
...
function nn(e, t, n, r) {
	...
	if (qt(i, a, r)) return e.step(new E(t, n, r));
	let o = sn(i, a);
	...
	for (let t = r.openStart; t >= 0; t--) {
		...
		if (f) for (let t = 0; t < o.length; t++) {
			...
			if (p.canReplaceWith(m, m, f.type, f.marks)) return e.replace(i.before(l), u ? a.after(l) : n, new d(rn(r.content, 0, r.openStart, s), s, r.openEnd));
		}
	}
...
}, un.prototype = Object.create(Error.prototype), un.prototype.constructor = un, un.prototype.name = "TransformError";
var dn = class {
	constructor(e) {
	...
	step(e) {
		...
		if (t.failed) throw new un(t.failed);
		return this;
	}
	maybeStep(e) {
	...
	removeNodeMark(e, t) {
		...
		if (t instanceof l) t.isInSet(n.marks) && this.step(new yt(e, t));
		else {
			let r = n.marks, i, a = [];
			for (; i = t.isInSet(r);) a.push(new yt(e, i)), r = i.removeFromSet(r);
	...
	static findFrom(e, t, n = !1) {
		let r = e.parent.inlineContent ? new k(e) : yn(e.node(0), e.parent, e.pos, e.index(), t, n);
		if (r) return r;
	...
	static atStart(e) {
		return yn(e, e, 0, 0, 1) || new j(e);
	}
	static atEnd(e) {
		return yn(e, e, e.content.size, e.childCount, -1) || new j(e);
	}
	static fromJSON(e, t) {
	...
	static jsonID(e, t) {
		if (e in fn) throw RangeError("Duplicate use of selection JSON ID " + e);
...
function hn(e) {
	!mn && !e.parent.inlineContent && (mn = !0, console.warn("TextSelection endpoint not pointing into a node with inline content (" + e.parent.type.name + ")"));
}
var k = class e extends O {
	...
	getBookmark() {
		return new gn(this.anchor, this.head);
	}
	toJSON() {
		return {
			type: "text",
...
function bn(e, t, n) {
	...
	if (r < t) return;
	let i = e.steps[r];
	if (!(i instanceof E || i instanceof D)) return;
	let a = e.mapping.maps[r], o;
	a.forEach((e, t, n, r) => {
		o ??= r;
	}), e.setSelection(O.near(e.doc.resolve(o), n));
}
var xn = 1, Sn = 2, Cn = 4, wn = class extends dn {
	constructor(e) {
...
var En = class {
	...
	static fromJSON(t, n, r) {
		...
		return i.fields.forEach((e) => {
			if (e.name == "doc") a.doc = C.fromJSON(t.schema, n.doc);
...
var M = class {
	constructor(e) {
		this.spec = e, this.props = {}, e.props && An(e.props, this, this.props), this.key = e.key ? e.key.key : Mn("plugin");
	}
	getState(e) {
		return e[this.key];
	}
...
}, Pn = (e, t) => !e.selection.empty && (t && t(e.tr.deleteSelection().scrollIntoView()), !0);
function Fn(e, t) {
...
var In = (e, t, n) => {
	...
	let i = Hn(r);
	if (!i) {
		let n = r.blockRange(), i = n && Tt(n);
		return i != null && (t && t(e.tr.lift(n, i).scrollIntoView()), !0);
	}
	let a = i.nodeBefore;
	if (or(e, i, t, -1)) return !0;
	if (r.parent.content.size == 0 && (Bn(a, "end") || A.isSelectable(a))) for (let n = r.depth;; n--) {
		let o = Kt(e.doc, r.before(n), r.after(n), d.empty);
		if (o && o.slice.size < o.to - o.from) {
			if (t) {
				let n = e.tr.step(o);
				n.setSelection(Bn(a, "end") ? O.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1) : A.create(n.doc, i.pos - a.nodeSize)), t(n.scrollIntoView());
			}
			return !0;
		}
...
function zn(e, t, n) {
	...
	let s = Kt(e.doc, i, o, d.empty);
	if (!s || s.from != i || s instanceof E && s.slice.size >= o - i) return !1;
	if (n) {
		let t = e.tr.step(s);
...
var Wn = (e, t, n) => {
	...
	let a = i.nodeAfter;
	if (or(e, i, t, 1)) return !0;
	if (r.parent.content.size == 0 && (Bn(a, "start") || A.isSelectable(a))) {
		let n = Kt(e.doc, r.before(), r.after(), d.empty);
		if (n && n.slice.size < n.to - n.from) {
			if (t) {
				let r = e.tr.step(n);
				r.setSelection(Bn(a, "start") ? O.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1) : A.create(r.doc, r.mapping.map(i.pos))), t(r.scrollIntoView());
			}
			return !0;
		}
	}
...
var qn = (e, t) => {
	...
	if (r) {
		if (n.node.isTextblock || !zt(e.doc, n.from)) return !1;
		i = n.from;
	} else if (i = Ht(e.doc, n.from, -1), i == null) return !1;
	if (t) {
		let n = e.tr.join(i);
	...
	let n = e.selection, r;
	if (n instanceof A) {
		if (n.node.isTextblock || !zt(e.doc, n.to)) return !1;
		r = n.to;
	} else if (r = Ht(e.doc, n.to, 1), r == null) return !1;
	return t && t(e.tr.join(r).scrollIntoView()), !0;
}, Yn = (e, t) => {
	let { $from: n, $to: r } = e.selection, i = n.blockRange(r), a = i && Tt(i);
...
var Qn = (e, t) => {
	...
	let r = n.blockRange(), i = r && Tt(r);
	return i != null && (t && t(e.tr.lift(r, i).scrollIntoView()), !0);
};
function tr(e) {
	return (t, n) => {
		let { $from: r, $to: i } = t.selection;
		if (t.selection instanceof A && t.selection.node.isBlock) return !r.parentOffset || !Lt(t.doc, r.pos) ? !1 : (n && n(t.tr.split(r.pos).scrollIntoView()), !0);
		if (!r.depth) return !1;
		let a = [], o, s, c = !1, l = !1;
		...
		let d = u.mapping.map(r.pos), f = Lt(u.doc, d, a.length, a);
		if (f ||= (a[0] = s ? { type: s } : null, Lt(u.doc, d, a.length, a)), !f) return !1;
...
var nr = tr(), rr = (e, t) => {
	...
	return a != 0 && (i = n.before(a), t && t(e.tr.setSelection(A.create(e.doc, i))), !0);
}, ir = (e, t) => (t && t(e.tr.setSelection(new j(e.doc))), !0);
function ar(e, t, n) {
...
function or(e, t, n, r) {
	...
	if (u && (s = (c = i.contentMatchAt(i.childCount)).findWrapping(o.type)) && c.matchType(s[0] || o.type).validEnd) {
		if (n) {
			...
			c = a.from(i.copy(c));
			let l = e.tr.step(new D(t.pos - 1, r, t.pos, r, new d(c, 1, 0), s.length, !0)), u = l.doc.resolve(r + 2 * s.length);
			u.nodeAfter && u.nodeAfter.type == i.type && zt(l.doc, u.pos) && l.join(u.pos), n(l.scrollIntoView());
		}
		return !0;
	}
	let f = o.type.spec.isolating || r > 0 && l ? null : O.findFrom(t, 1), p = f && f.$from.blockRange(f.$to), m = p && Tt(p);
	...
	if (u && Bn(o, "start", !0) && Bn(i, "end")) {
		...
		if (r.canReplace(r.childCount, r.childCount, c.content)) {
			if (n) {
				...
				n(e.tr.step(new D(t.pos - s.length, t.pos + o.nodeSize, t.pos + l, t.pos + o.nodeSize - l, new d(r, s.length, 0), 0, !0)).scrollIntoView());
			}
			return !0;
		}
	}
...
function ur(e, t = null) {
	return function(n, r) {
		let { $from: i, $to: a } = n.selection, o = i.blockRange(a), s = o && Dt(o, e, t);
...
function yr(e, t, n, r, i) {
	...
	e.step(new D(t.start - (r ? 2 : 0), t.end, t.start, t.end, new d(o, 0, 0), n.length, !0));
	let s = 0;
	for (let e = 0; e < n.length; e++) n[e].type == i && (s = e + 1);
	let c = n.length - s, l = t.start + n.length - (r ? 2 : 0), u = t.parent;
	for (let n = t.startIndex, r = t.endIndex, i = !0; n < r; n++, i = !1) !i && Lt(e.doc, l, c) && (e.split(l, c), l += 2 * c), l += u.child(n).nodeSize;
	return e;
}
function br(e) {
	return function(t, n) {
...
function xr(e, t, n, r) {
	...
	o < s && (i.step(new D(o - 1, s, o, s, new d(a.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new ae(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
	let c = Tt(r);
	if (c == null) return !1;
	i.lift(r, c);
	let l = i.doc.resolve(i.mapping.map(o, -1) - 1);
	return zt(i.doc, l.pos) && l.nodeBefore.type == l.nodeAfter.type && i.join(l.pos), t(i.scrollIntoView()), !0;
}
function Sr(e, t, n) {
	...
	return r.step(new D(p - +!!c, m + +!!l, p + 1, m - 1, new d((c ? a.empty : a.from(i.copy(a.empty))).append(l ? a.empty : a.from(i.copy(a.empty))), +!c, +!l), +!c)), t(r.scrollIntoView()), !0;
}
function Cr(e) {
	return function(t, n) {
		...
		if (n) {
			...
			n(t.tr.step(new D(u - (r ? 3 : 1), f, u, f, s, 1, !0)).scrollIntoView());
		}
		return !0;
	};
}
...
var V = 0, Ai = 1, ji = 2, H = 3, Mi = class {
	...
	markDirty(e, t) {
		for (let n = 0, r = 0; r < this.children.length; r++) {
			...
			if (n == a ? e <= a && t >= n : e < a && t > n) {
				...
				i.dirty = i.dom == i.contentDOM && i.dom.parentNode == this.contentDOM && !i.children.length ? ji : H;
			}
			n = a;
		}
		this.dirty = ji;
	...
	static create(t, n, r, i) {
		...
		return (!o || !o.dom) && (o = Ye.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)), new e(t, n, o.dom, o.contentDOM || o.dom, o);
	}
	parseRule() {
	...
	static create(t, n, r, i, a, o) {
		...
		if (n.isText) {
			...
			let e = Ye.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs);
...
function ra(e, t = null) {
	...
	if (Fr(n)) {
		...
		let e = i.node;
		if (i && e.isAtom && A.isSelectable(e) && i.parent && !(e.isInline && Nr(n.focusNode, n.focusOffset, i.dom))) {
			let e = i.posBefore;
...
function aa(e, t = !1) {
	...
	if (e.domObserver.disconnectSelection(), e.cursorWrapper) da(e);
		...
		oa && !(n instanceof k) && (n.$from.parent.inlineContent || (a = sa(e, n.from)), !n.empty && !n.$from.parent.inlineContent && (o = sa(e, n.to))), e.docView.setSelection(r, i, e, t), oa && (a && la(a), o && la(o)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && ua(e));
	}
...
function sa(e, t) {
	...
	if (z && i && i.contentEditable == "false") return ca(i);
...
function ba(e, t, n) {
	...
	if (r instanceof k) {
		if (n.indexOf("s") > -1) {
			...
			return ya(e, new k(r.$anchor, a));
		}
		if (!r.empty) return !1;
		if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
			let n = va(e.state, t);
			return n && n instanceof A ? ya(e, n) : !1;
		}
		if (!(B && n.indexOf("m") > -1)) {
			let n = r.$head, i = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter, a;
			if (!i || i.isText) return !1;
			let o = t < 0 ? n.pos - i.nodeSize : n.pos;
			return i.isAtom || (a = e.docView.descAt(o)) && !a.contentDOM ? A.isSelectable(i) ? ya(e, new A(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n)) : Xr ? ya(e, new k(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize))) : !1 : !1;
		}
	} else if (r instanceof A && r.node.isInline) return ya(e, new k(t > 0 ? r.$to : r.$from));
	else {
		let n = va(e.state, t);
		return n ? ya(e, n) : !1;
	}
...
function wa(e) {
	...
	if (!n) return;
	let i, a, o = !1;
	for (L && n.nodeType == 1 && r < xa(n) && Sa(n.childNodes[r], -1) && (o = !0);;) if (r > 0) {
		...
		for (; t && Sa(t, -1);) i = n.parentNode, a = N(t), t = t.previousSibling;
		if (t) n = t, r = xa(n);
		else {
...
function Ta(e) {
	...
	for (;;) if (r < i) {
		...
		let t = n.nextSibling;
		for (; t && Sa(t, 1);) a = t.parentNode, o = N(t) + 1, t = t.nextSibling;
		if (t) n = t, r = 0, i = xa(n);
		else {
			if (n = n.parentNode, n == e.dom) break;
			r = i = 0;
...
function ja(e, t, n) {
	...
	if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
		let n = va(e.state, t);
		if (n && n instanceof A) return ya(e, n);
	}
...
function Ia(e, t) {
	...
	if (n == 8 || B && n == 72 && r == "c") return Ma(e, -1) || Ca(e, -1);
	if (n == 46 && !t.shiftKey || B && n == 68 && r == "c") return Ma(e, 1) || Ca(e, 1);
	...
	return n == 38 || B && n == 80 && r == "c" ? ja(e, -1, r) || Ca(e, -1) : n == 40 || B && n == 78 && r == "c" ? Pa(e) || ja(e, 1, r) || Ca(e, 1) : !(r != (B ? "m" : "c") || n != 66 && n != 73 && n != 89 && n != 90);
}
function La(e, t) {
	...
	let o = e.someProp("clipboardSerializer") || Ye.fromSchema(e.state.schema), s = qa(), c = s.createElement("div");
...
function Ra(e, t, n, r, i) {
	...
	if (l) {
		...
		if (n) c = n;
			...
			let n = i.marks(), { schema: r } = e.state, a = Ye.fromSchema(r);
	...
	if (c ||= (e.someProp("clipboardParser") || e.someProp("domParser") || Fe.fromSchema(e.state.schema)).parseSlice(s, {
		preserveWhitespace: !!(l || f),
		context: i,
		ruleFromNode(e) {
			return e.nodeName == "BR" && !e.nextSibling && e.parentNode && !za.test(e.parentNode.nodeName) ? { ignore: !0 } : null;
		}
	}), f) c = Qa(Ga(c, +f[1], +f[2]), f[4]);
...
function Ya(e) {
	...
	return t ? (Ja ||= t.defaultPolicy || t.createPolicy("ProseMirrorClipboard", { createHTML: (e) => e }), Ja.createHTML(e)) : e;
}
function Xa(e) {
	let t = /^(\s*<meta [^>]*>)*/.exec(e);
	t && (e = e.slice(t[0].length));
	let n = qa(), r = n.body, i = /<([a-z][^>\s]+)/i.exec(e), a;
	if ((a = i && Ka[i[1].toLowerCase()]) && (e = a.map((e) => "<" + e + ">").join("") + e + a.map((e) => "</" + e + ">").reverse().join("")), r.innerHTML = Ya(e), a) for (let e = 0; e < a.length; e++) r = r.querySelector(a[e]) || r;
...
function to(e) {
	for (let t in U) {
		...
		e.dom.addEventListener(t, e.input.eventHandlers[t] = (t) => {
			oo(e, t) && !ao(e, t) && (e.editable || !(t.type in W)) && n(e, t);
		}, $a[t] ? { passive: !0 } : void 0);
	}
	z && e.dom.addEventListener("input", () => null), io(e);
}
function no(e, t) {
...
function io(e) {
	e.someProp("handleDOMEvents", (t) => {
		for (let n in t) e.input.eventHandlers[n] || e.dom.addEventListener(n, e.input.eventHandlers[n] = (t) => ao(e, t));
	});
}
function ao(e, t) {
...
function so(e, t) {
	!ao(e, t) && U[t.type] && (e.editable || !(t.type in W)) && U[t.type](e, t);
}
W.keydown = (e, t) => {
	let n = t;
	if (e.input.shiftKey = n.keyCode == 16 || n.shiftKey, !To(e) && (e.input.lastKeyCode = n.keyCode, e.input.lastKeyCodeTime = Date.now(), !(Yr && R && n.keyCode == 13))) if (n.keyCode != 229 && e.domObserver.forceFlush(), qr && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey) {
		let t = Date.now();
	...
	} else e.someProp("handleKeyDown", (t) => t(e, n)) || Ia(e, n) ? n.preventDefault() : no(e, "key");
}, W.keyup = (e, t) => {
	t.keyCode == 16 && (e.input.shiftKey = !1);
}, W.keypress = (e, t) => {
	let n = t;
	if (To(e) || !n.charCode || n.ctrlKey && !n.altKey || B && n.metaKey) return;
...
function po(e, t) {
	...
	return r && r.isAtom && A.isSelectable(r) ? (fo(e, new A(n), "pointer"), !0) : !1;
}
function mo(e, t) {
	if (t == -1) return !1;
	...
	return i != null && (fo(e, A.create(e.state.doc, i), "pointer"), !0);
}
function ho(e, t, n, r, i) {
	return uo(e, "handleClickOn", t, n, r) || e.someProp("handleClick", (n) => n(e, t, r)) || (i ? mo(e, n) : po(e, n));
}
function go(e, t, n, r) {
	return uo(e, "handleDoubleClickOn", t, n, r) || e.someProp("handleDoubleClick", (n) => n(e, t, r));
}
function _o(e, t, n, r) {
	return uo(e, "handleTripleClickOn", t, n, r) || e.someProp("handleTripleClick", (n) => n(e, t, r)) || vo(e, n, r);
}
function vo(e, t, n) {
	if (n.button != 0) return !1;
	let r = yo(e, t, !0), i = e.state.doc;
	return r ? (fo(e, r, "pointer"), r instanceof k && i.eq(e.state.doc) && (e.input.mouseDown = new wo(e, r)), !0) : !1;
}
function yo(e, t, n) {
	let r = e.state.doc;
...
var xo = B ? "metaKey" : "ctrlKey";
U.mousedown = (e, t) => {
	let n = t;
	e.input.shiftKey = n.shiftKey;
	let r = bo(e), i = Date.now(), a = "singleClick";
	i - e.input.lastClick.time < 500 && lo(n, e.input.lastClick) && !n[xo] && e.input.lastClick.button == n.button && (e.input.lastClick.type == "singleClick" ? a = "doubleClick" : e.input.lastClick.type == "doubleClick" && (a = "tripleClick")), e.input.lastClick = {
		time: i,
		x: n.clientX,
		y: n.clientY,
		type: a,
	...
	let o = e.posAtCoords(co(n));
	o && (a == "singleClick" ? e.input.mouseDown = new Co(e, o, n, !!r) : (a == "doubleClick" ? go : _o)(e, o.pos, o.inside, n) ? n.preventDefault() : no(e, "pointer"));
};
var So = class {
	constructor(e) {
	...
	constructor(e, t, n, r) {
		...
		}, 20), this.view.domObserver.start()), no(e, "pointer");
	}
	done() {
		super.done(), this.mightDrag && this.target && (this.view.domObserver.stop(), this.mightDrag.addAttr && this.target.removeAttribute("draggable"), this.mightDrag.setUneditable && this.target.removeAttribute("contentEditable"), this.view.domObserver.start()), this.delayedSelectionSync && setTimeout(() => {
			this.view.isDestroyed || aa(this.view);
		});
	}
	up(e) {
		if (this.done(), !this.view.dom.contains(e.target)) return;
		let t = this.pos;
		this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(co(e))), this.updateAllowDefault(e), this.allowDefault || !t ? no(this.view, "pointer") : ho(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || z && this.mightDrag && !this.mightDrag.node.isAtom || R && !this.view.state.selection.visible && Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to)) <= 2) ? (fo(this.view, O.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault()) : no(this.view, "pointer");
	}
	move(e) {
		this.updateAllowDefault(e), no(this.view, "pointer"), super.move(e);
	}
	...
	move(e) {
		...
		e.preventDefault(), no(this.view, "pointer");
		let t = this.view.posAtCoords(co(e)), n = t && yo(this.view, t.inside, !1);
		if (!n) return;
		let { doc: r } = this.view.state, i = this.startSelection, [a, o] = n.from < i.from ? [i.to, n.from] : [i.from, n.to];
		fo(this.view, k.create(r, a, o), "pointer");
	}
};
U.touchstart = (e) => {
	e.input.lastTouch = Date.now(), bo(e), no(e, "pointer");
}, U.touchmove = (e) => {
	e.input.lastTouch = Date.now(), no(e, "pointer");
}, U.contextmenu = (e) => bo(e);
function To(e, t) {
...
W.compositionstart = W.compositionupdate = (e) => {
	if (!e.composing) {
		...
		if (t.selection instanceof k && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some((e) => e.type.spec.inclusive === !1) || R && Jr && Do(e))) e.markCursor = e.state.storedMarks || n.marks(), jo(e, !0), e.markCursor = null;
		else if (jo(e, !t.selection.empty), L && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
			let t = e.domSelectionRange();
...
var No = I && Wr < 15 || qr && Zr < 604;
U.copy = W.cut = (e, t) => {
	let n = t, r = e.state.selection, i = n.type == "cut";
	if (r.empty) return;
	let a = No ? null : n.clipboardData, { dom: o, text: s } = La(e, r.content());
...
U.dragstart = (e, t) => {
	...
	let i = e.state.selection, a = i.empty ? null : e.posAtCoords(co(n)), o;
	...
	(!n.dataTransfer.files.length || !R || Kr > 120) && n.dataTransfer.clearData(), n.dataTransfer.setData(No ? "Text" : "text/html", s.innerHTML), n.dataTransfer.effectAllowed = "copyMove", No || n.dataTransfer.setData("text/plain", c), e.dragging = new Ro(l, Bo(e, n), o);
}, U.dragend = (e) => {
	let t = e.dragging;
	window.setTimeout(() => {
...
function Vo(e, t, n) {
	...
	let r = e.posAtCoords(co(t));
	if (!r) return;
	let i = e.state.doc.resolve(r.pos), a = n && n.slice;
	a ? e.someProp("transformPasted", (t) => {
		a = t(a, e, !1);
	}) : a = Ra(e, Lo(t.dataTransfer), No ? null : t.dataTransfer.getData("text/html"), !1, i);
	let o = !!(n && Bo(e, t));
	...
	if (!a) return;
	t.preventDefault();
	let s = a ? Gt(e.state.doc, i.pos, a) : i.pos;
	s ??= i.pos;
	let c = e.state.tr;
	if (o) {
		let { node: e } = n;
	...
	if (u && A.isSelectable(a.content.firstChild) && p.nodeAfter && p.nodeAfter.sameMarkup(a.content.firstChild)) c.setSelection(new A(p));
	else {
...
var Uo = class e {
	constructor(e, t) {
		this.toDOM = e, this.spec = t || Jo, this.side = this.spec.side || 0;
	}
	map(e, t, n, r) {
		let { pos: i, deleted: a } = e.mapResult(t.from + r, this.side < 0 ? -1 : 1);
		return a ? null : new Ko(i - n, i - n, this);
	}
	valid() {
		return !0;
	}
	...
	map(e, t, n, r) {
		...
		return a.deleted || a.pos <= i.pos ? null : new Ko(i.pos - n, a.pos - n, this);
	}
	valid(e, t) {
	...
	constructor(e, t) {
		this.local = e.length ? e : qo, this.children = t.length ? t : qo;
	}
	static create(e, t) {
		return t.length ? ts(t, e, 0, Jo) : K;
	}
	find(e, t, n) {
		let r = [];
	...
	map(e, t, n) {
		return this == K || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || Jo);
	}
	mapInner(t, n, r, i, a) {
		let o;
		...
		return this.children.length ? Xo(this.children, o || [], t, n, r, i, a) : o ? new e(o.sort(ns), qo) : K;
	}
	add(t, n) {
	...
	addInner(t, n, r) {
		...
		t.forEach((e, t) => {
			...
			if (s = $o(n, e, o)) {
				...
				i[a] == t ? i[a + 2] = i[a + 2].addInner(e, s, o + 1) : i.splice(a, 0, t, t + e.nodeSize, ts(s, e, o + 1, Jo)), a += 3;
			}
		});
		let o = Zo(a ? es(n) : n, -r);
		for (let e = 0; e < o.length; e++) o[e].type.valid(t, o[e]) || o.splice(e--, 1);
		return new e(o.length ? this.local.concat(o).sort(ns) : this.local, i || this.children);
	}
	remove(e) {
	...
	forChild(t, n) {
		...
		if (i) {
			let t = new e(i.sort(ns), qo);
			return r ? new Yo([t, r]) : t;
		}
		return r || K;
	}
	eq(t) {
...
G.empty = new G([], []), G.removeOverlap = rs;
var K = G.empty, Yo = class e {
	constructor(e) {
		this.members = e;
	}
	map(t, n) {
		let r = this.members.map((e) => e.map(t, n, Jo));
		return e.from(r);
	}
	forChild(t, n) {
...
function Xo(e, t, n, r, i, a, o) {
	...
	if (c) {
		let c = ts(Qo(s, e, t, n, i, a, o), r, 0, o);
		t = c.local;
...
function Zo(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		let i = e[r];
		n.push(new Ko(i.from + t, i.to + t, i.type));
	}
	return n;
}
...
function ts(e, t, n, r) {
	...
	t.forEach((t, o) => {
		...
		if (s) {
			a = !0;
			let e = ts(s, t, n + o + 1, r);
			e != K && i.push(o, o + t.nodeSize, e);
		}
	});
	let o = Zo(a ? es(e) : e, -n).sort(ns);
...
function as(e) {
	...
	return e.someProp("decorations", (n) => {
		let r = n(e.state);
		r && r != K && t.push(r);
	}), e.cursorWrapper && t.push(G.create(e.state.doc, [e.cursorWrapper.deco])), Yo.from(t);
}
var ss = {
	childList: !0,
	characterData: !0,
	...
	constructor(e, t) {
		this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new ls(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((t) => {
	...
	start() {
		this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, ss)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
	}
	stop() {
		if (this.observer) {
	...
	flush() {
		...
		if (s.some((e) => e.nodeName == "BR") && (e.input.lastKeyCode == 8 || e.input.lastKeyCode == 46 || R && (e.composing || e.input.compositionEndedAt > Date.now() - 50) && t.some((e) => e.type == "childList" && e.removedNodes.length))) {
			...
			if (t.length == 2) {
				...
				for (let r of t) {
					let t = r.parentNode;
					t && t.nodeName == "LI" && (!n || gs(e, n) != t) && r.remove();
				}
			}
		}
		let c = null;
		i < 0 && r && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Fr(n) && (c = ra(e)) && c.eq(O.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, aa(e), this.currentSelection.set(n), e.scrollToSelection()) : (i > -1 || r) && (i > -1 && (e.docView.markDirty(i, a), ps(e)), e.input.badSafariComposition && (e.input.badSafariComposition = !1, _s(e, s)), this.handleDOMChange(i, a, o, s), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || aa(e), this.currentSelection.set(n));
	}
...
}, ds = /* @__PURE__ */ new WeakMap(), fs = !1;
function ps(e) {
	if (!ds.has(e) && (ds.set(e, null), [
		"normal",
		"nowrap",
		"pre-line"
	].indexOf(getComputedStyle(e.dom).whiteSpace) !== -1)) {
		if (e.requiresGeckoHackNode = L, fs) return;
...
function vs(e, t, n, r) {
	...
	let f = e.state.doc, p = e.someProp("domParser") || Fe.fromSchema(e.state.schema), m = f.resolve(s), h = null, g = p.parse(i, {
		topNode: m.parent,
...
var ys = (e) => (t) => {
	...
	if (t.nodeName == "BR" && t.parentNode) {
		...
		if (t.parentNode.lastChild == t || z && /^(tr|table)$/i.test(t.parentNode.nodeName)) return { ignore: !0 };
...
function xs(e, t, n, r, i) {
	...
	let c = e.state.selection, l = vs(e, t, n, i), u = e.state.doc, d = u.slice(l.from, l.to), f, p;
	...
	let m = Es(d.content, l.doc.content, l.from, f, p);
	if (m && e.input.domChangeCount++, (qr && e.input.lastIOSEnter > Date.now() - 225 || Yr) && i.some((e) => e.nodeType == 1 && !bs.test(e.nodeName)) && (!m || m.endA >= m.endB) && e.someProp("handleKeyDown", (t) => t(e, Ir(13, "Enter")))) {
	...
	e.state.selection.from < e.state.selection.to && m.start == m.endB && e.state.selection instanceof k && (m.start > e.state.selection.from && m.start <= e.state.selection.from + 2 && e.state.selection.from >= l.from ? m.start = e.state.selection.from : m.endA < e.state.selection.to && m.endA >= e.state.selection.to - 2 && e.state.selection.to <= l.to && (m.endB += e.state.selection.to - m.endA, m.endA = e.state.selection.to)), I && Wr <= 11 && m.endB == m.start + 1 && m.endA == m.start && m.start > l.from && l.doc.textBetween(m.start - l.from - 1, m.start - l.from + 1) == " \xA0" && (m.start--, m.endA--, m.endB--);
	...
	if (e.state.selection.anchor > m.start && ws(u, m.start, m.endA, h, g) && e.someProp("handleKeyDown", (t) => t(e, Ir(8, "Backspace")))) {
	...
	if (v) if (h.pos == g.pos) {
		I && Wr <= 11 && h.parentOffset == 0 && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => aa(e), 20));
		let t = x(e.state.tr.delete(y, b)), n = u.resolve(m.start).marksAcross(u.resolve(m.endA));
		n && t.ensureMarks(n), e.dispatch(t);
	} else if (m.endA == m.endB && (S = Cs(h.parent.content.cut(h.parentOffset, g.parentOffset), _.parent.content.cut(_.parentOffset, m.endA - _.start())))) {
		let t = x(e.state.tr);
...
function ws(e, t, n, r, i) {
	if (n - t <= i.pos - r.pos || Ts(r, !0, !1) < i.pos) return !1;
	let a = e.resolve(t);
	if (!r.parent.isTextblock) {
		let e = a.nodeAfter;
	...
	let o = e.resolve(Ts(a, !0, !0));
	return !o.parent.isTextblock || o.pos > n || Ts(o, !0, !1) < n ? !1 : r.parent.content.cut(r.parentOffset).eq(o.parent.content);
}
function Ts(e, t, n) {
...
var Ds = class {
	...
	updateStateInner(e, t) {
		...
		(a || t.handleDOMEvents != this._props.handleDOMEvents) && io(this), this.editable = As(this), ks(this);
		let o = as(this), s = Os(this), c = n.plugins != e.plugins && !n.doc.eq(e.doc) ? "reset" : e.scrollToSelection > n.scrollToSelection ? "to selection" : "preserve", l = r || !this.docView.matchesNode(e.doc, s, o);
		(l || !e.selection.eq(n.selection)) && (i = !0);
		let u = c == "preserve" && i && this.dom.style.overflowAnchor == null && ni(this);
		if (i) {
			this.domObserver.stop();
			let t = l && (I || R) && !this.composing && !n.selection.empty && !e.selection.empty && js(n.selection, e.selection);
			if (l) {
				let n = R ? this.trackWrites = this.domSelectionRange().focusNode : null;
				this.composing && (this.input.compositionNode = Ao(this)), (r || !this.docView.update(e.doc, s, o, this)) && (this.docView.updateOuterDeco(s), this.docView.destroy(), this.docView = Li(e.doc, s, o, this.dom, this)), n && (!this.trackWrites || !this.dom.contains(this.trackWrites)) && (t = !0);
			}
			let i = this.input.mouseDown;
			t || !(i && this.domObserver.currentSelection.eq(this.domSelectionRange()) && _a(this) && i.delaySelUpdate()) ? aa(this, t) : (fa(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
		}
	...
	updateDraggedNode(e, t) {
		...
		this.dragging = new Ro(e.slice, e.move, r < 0 ? void 0 : A.create(this.state.doc, r));
	}
	someProp(e, t) {
	...
	focus() {
		this.domObserver.stop(), this.editable && si(this.dom), aa(this), this.domObserver.start();
	}
	get root() {
		let e = this._root;
		if (e == null) {
	...
	destroy() {
		this.docView && (ro(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], as(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Dr());
	}
	get isDestroyed() {
	...
	domSelectionRange() {
		...
		return e ? z && this.root.nodeType === 11 && Lr(this.dom.ownerDocument) == this.dom && hs(this, e) || e : {
			focusNode: null,
			focusOffset: 0,
			anchorNode: null,
			anchorOffset: 0
...
function Os(e) {
	...
	}), t.translate ||= "no", [Ko.node(0, e.state.doc.content.size, t)];
}
function ks(e) {
	if (e.markCursor) {
		...
		t.className = "ProseMirror-separator", t.setAttribute("mark-placeholder", "true"), t.setAttribute("alt", ""), e.cursorWrapper = {
			dom: t,
			deco: Ko.widget(e.state.selection.from, t, {
				raw: !0,
				marks: e.markCursor
			})
		};
...
for (var Fs = {
	...
	221: "}",
	222: "\""
}, Ls = typeof navigator < "u" && /Mac/.test(navigator.platform), Rs = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), q = 0; q < 10; q++) Fs[48 + q] = Fs[96 + q] = String(q);
for (var q = 1; q <= 24; q++) Fs[q + 111] = "F" + q;
for (var q = 65; q <= 90; q++) Fs[q] = String.fromCharCode(q + 32), Is[q] = String.fromCharCode(q);
...
var Vs = typeof navigator < "u" && /Mac|iP(hone|[oa]d)/.test(navigator.platform), Hs = typeof navigator < "u" && /Win/.test(navigator.platform);
function Us(e) {
...
function Ks(e) {
	return new M({ props: { handleKeyDown: qs(e) } });
}
function qs(e) {
	let t = Ws(e);
	return function(e, n) {
		let r = Bs(n), i, a = t[Gs(r, n)];
		...
		if (r.length == 1 && r != " ") {
			...
			if ((n.altKey || n.metaKey || n.ctrlKey) && !(Hs && n.ctrlKey && n.altKey) && (i = Fs[n.keyCode]) && i != r) {
				let r = t[Gs(i, n)];
...
var Js = Object.defineProperty, Ys = (e, t) => {
...
Ys(Qs, {
	...
	insertContent: () => Oc,
	insertContentAt: () => Pc,
	insertDefaultBlock: () => Ic,
	joinBackward: () => zc,
	joinDown: () => Rc,
	joinForward: () => Bc,
	joinItemBackward: () => Vc,
	joinItemForward: () => Hc,
	joinTextblockBackward: () => Uc,
	joinTextblockForward: () => Wc,
	joinUp: () => Lc,
	keyboardShortcut: () => qc,
	lift: () => Yc,
	liftEmptyBlock: () => Xc,
	...
	unsetAllMarks: () => Fu,
	unsetMark: () => Iu,
	unsetTextDirection: () => Lu,
	updateAttributes: () => Ru,
	wrapIn: () => zu,
	wrapInList: () => Bu
});
var $s = () => ({ editor: e, view: t }) => (requestAnimationFrame(() => {
	var n;
	e.isDestroyed || (t.dom.blur(), (n = window == null ? void 0 : window.getSelection()) == null || n.removeAllRanges());
}), !0), ec = (e = !0) => ({ commands: t }) => t.setContent("", { emitUpdate: e }), tc = () => ({ state: e, tr: t, dispatch: n }) => {
...
}, nc = (e) => (t) => e(t), rc = () => ({ state: e, dispatch: t }) => $n(e, t), ic = (e, t) => ({ editor: n, tr: r }) => {
...
var oc = (e) => ({ tr: t, state: n, dispatch: r }) => {
	...
	return !1;
}, sc = (e) => ({ tr: t, dispatch: n }) => {
	let { from: r, to: i } = e;
	return n && t.delete(r, i), !0;
}, cc = (e) => e.content ? /^text(\*|\+)/.test(e.content) : !1, lc = (e, t, n) => {
	if (!e.parent.isInline || n === "left" && e.pos > e.start() || n === "right" && e.pos < e.end()) return e.pos;
	let r = t.nodes[e.parent.type.name].spec;
	return cc(r) ? n === "left" ? e.start() - 1 : e.end() + 1 : e.pos;
}, uc = (e, t, n) => ({
	from: lc(e, n, "left"),
	to: lc(t, n, "right")
}), dc = () => ({ state: e, dispatch: t }) => {
	if (e.selection.empty) return !1;
	if (t) {
		let n = e.tr, { ranges: r } = e.selection, i = n.steps.length;
		r.forEach((t) => {
			let r = n.mapping.slice(i), { from: a, to: o } = uc(n.doc.resolve(r.map(t.$from.pos)), n.doc.resolve(r.map(t.$to.pos)), e.schema);
			n.deleteRange(a, o);
		}), n.selection.empty || n.setSelection(k.near(n.doc.resolve(n.selection.from))), n.scrollIntoView(), t(n);
	}
	return !0;
}, fc = () => ({ commands: e }) => e.keyboardShortcut("Enter"), pc = () => ({ state: e, dispatch: t }) => Qn(e, t);
function mc(e) {
	return Object.prototype.toString.call(e) === "[object RegExp]";
}
function hc(e, t, n = { strict: !0 }) {
	let r = Object.keys(t);
	return !r.length || r.every((r) => n.strict ? t[r] === e[r] : mc(t[r]) ? t[r].test(e[r]) : t[r] === e[r]);
}
function gc(e, t, n = {}) {
	return e.find((e) => e.type === t && hc(Object.fromEntries(Object.keys(n).map((t) => [t, e.attrs[t]])), n));
}
function _c(e, t, n = {}) {
	return !!gc(e, t, n);
}
function vc(e, t, n) {
	...
	if (!gc([...r.node.marks], t, n)) return;
	let i = r.index, a = e.start() + r.offset, o = i + 1, s = a + r.node.nodeSize;
	for (; i > 0 && _c([...e.parent.child(i - 1).marks], t, n);) --i, a -= e.parent.child(i).nodeSize;
	for (; o < e.parent.childCount && _c([...e.parent.child(o).marks], t, n);) s += e.parent.child(o).nodeSize, o += 1;
	return {
		from: a,
		to: s
	};
...
var Ec = (e = null, t = {}) => ({ editor: n, view: r, tr: i, dispatch: a }) => {
	t = {
		scrollIntoView: !0,
		...t
	};
	let o = () => {
		(wc() || Cc()) && r.dom.focus(), Tc() && !wc() && !Cc() && r.dom.focus({ preventScroll: !0 }), requestAnimationFrame(() => {
	...
	let s = Sc(i.doc, e) || n.state.selection, c = n.state.selection.eq(s);
	return a && (c || i.setSelection(s), c && i.storedMarks && i.setStoredMarks(i.storedMarks), o()), !0;
}, Dc = (e, t) => (n) => e.every((e, r) => t(e, {
	...n,
	index: r
})), Oc = (e, t) => ({ tr: n, commands: r }) => r.insertContentAt({
	...
	for (let n = t.length - 1; n >= 0; --n) {
		let r = t[n];
		r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? e.removeChild(r) : r.nodeType === 1 && kc(r);
	}
	return e;
};
function Ac(e) {
...
function jc(e, t, n) {
	if (e instanceof C || e instanceof a) return e;
	n = {
		slice: !0,
		parseOptions: {},
		...n
	...
	if (r) try {
		...
		return console.warn("[tiptap warn]: Invalid content.", "Passed value:", e, "Error:", r), jc("", t, n);
	}
	if (i) {
		if (n.errorOnInvalidContent) {
			...
			if (n.slice ? Fe.fromSchema(a).parseSlice(Ac(e), n.parseOptions) : Fe.fromSchema(a).parse(Ac(e), n.parseOptions), n.errorOnInvalidContent && r) throw Error("[tiptap error]: Invalid HTML content", { cause: /* @__PURE__ */ Error(`Invalid element found: ${i}`) });
		}
		let r = Fe.fromSchema(t);
		return n.slice ? r.parseSlice(Ac(e), n.parseOptions).content : r.parse(Ac(e), n.parseOptions);
	}
	return jc("", t, n);
}
function Mc(e, t, n) {
...
var Nc = (e) => !("type" in e), Pc = (e, t, n) => ({ tr: r, dispatch: i, editor: o }) => {
	if (i) {
		n = {
...
}, Lc = () => ({ state: e, dispatch: t }) => qn(e, t), Rc = () => ({ state: e, dispatch: t }) => Jn(e, t), zc = () => ({ state: e, dispatch: t }) => In(e, t), Bc = () => ({ state: e, dispatch: t }) => Wn(e, t), Vc = () => ({ state: e, dispatch: t, tr: n }) => {
	try {
		let r = Ht(e.doc, e.selection.$from.pos, -1);
		return r != null && (n.join(r, 2), t && t(n), !0);
	} catch {
		return !1;
	}
}, Hc = () => ({ state: e, dispatch: t, tr: n }) => {
	try {
		let r = Ht(e.doc, e.selection.$from.pos, 1);
		return r != null && (n.join(r, 2), t && t(n), !0);
	} catch {
...
}, Uc = () => ({ state: e, dispatch: t }) => Ln(e, t), Wc = () => ({ state: e, dispatch: t }) => Rn(e, t);
function Gc() {
...
function Kc(e) {
	...
	for (let e = 0; e < t.length - 1; e += 1) {
		...
		else if (/^mod$/i.test(n)) wc() || Gc() ? o = !0 : i = !0;
		else throw Error(`Unrecognized modifier name: ${n}`);
	}
	return r && (n = `Alt-${n}`), i && (n = `Ctrl-${n}`), o && (n = `Meta-${n}`), a && (n = `Shift-${n}`), n;
}
var qc = (e) => ({ editor: t, view: n, tr: r, dispatch: i }) => {
	let a = Kc(e).split(/-(?!$)/), o = a.find((e) => ![
		"Alt",
		"Ctrl",
		"Meta",
		"Shift"
...
function Jc(e, t, n = {}) {
	...
	let c = i - r, l = s.filter((e) => !o || o.name === e.node.type.name).filter((e) => hc(e.node.attrs, n, { strict: !1 }));
	return a ? !!l.length : l.reduce((e, t) => e + t.to - t.from, 0) >= c;
}
var Yc = (e, t = {}) => ({ state: n, dispatch: r }) => Jc(n, J(e, n.schema), t) ? Yn(n, r) : !1, Xc = () => ({ state: e, dispatch: t }) => er(e, t), Zc = (e) => ({ state: t, dispatch: n }) => br(J(e, t.schema))(t, n), Qc = () => ({ state: e, dispatch: t }) => Xn(e, t);
function $c(e, t) {
...
var tl = (e, t) => ({ tr: n, state: r, dispatch: i }) => {
	let a = null, o = null, s = $c(typeof e == "string" ? e : e.name, r.schema);
	if (!s) return !1;
...
}, nl = () => ({ tr: e, dispatch: t }) => (t && e.scrollIntoView(), !0), rl = () => ({ tr: e, dispatch: t }) => {
	if (t) {
		let t = new j(e.doc);
		e.setSelection(t);
	}
	return !0;
}, il = () => ({ state: e, dispatch: t }) => Vn(e, t), al = () => ({ state: e, dispatch: t }) => Gn(e, t), ol = () => ({ state: e, dispatch: t }) => rr(e, t), sl = () => ({ state: e, dispatch: t }) => lr(e, t), cl = () => ({ state: e, dispatch: t }) => cr(e, t);
function ll(e, t, n = {}, r = {}) {
	return jc(e, t, {
		slice: !1,
		parseOptions: n,
...
var ul = (e, { errorOnInvalidContent: t, emitUpdate: n = !0, parseOptions: r = {} } = {}) => ({ editor: i, tr: a, dispatch: o, commands: s }) => {
	let { doc: c } = a;
	if (r.preserveWhitespace !== "full") {
		let s = ll(e, i.schema, r, { errorOnInvalidContent: t ?? i.options.enableContentCheck });
...
function vl(e, t) {
	let n = Ye.fromSchema(t).serializeFragment(e), r = document.implementation.createHTMLDocument().createElement("div");
...
function Sl(e) {
	let t = [], { nodeExtensions: n, markExtensions: r } = xl(e), i = [...n, ...r], a = {
		default: null,
		validate: void 0,
		rendered: !0,
		renderHTML: null,
...
function El(e, t) {
	return t.filter((t) => t.type === e.type.name).filter((e) => e.attribute.rendered).map((t) => t.attribute.renderHTML ? t.attribute.renderHTML(e.attrs) || {} : { [t.name]: e.attrs[t.name] }).reduce((e, t) => Tl(e, t), {});
}
function Dl(e) {
...
function Ol(e, t) {
	return "style" in e ? e : {
		...
		getAttrs: (n) => {
			...
			if (r === !1) return !1;
			let i = t.reduce((e, t) => {
				let r = t.attribute.parseHTML ? t.attribute.parseHTML(n) : Dl(n.getAttribute(t.name));
				return r == null ? e : {
					...e,
					[t.name]: r
				};
...
function jl(e, t) {
	let n = Sl(e), { nodeExtensions: r, markExtensions: i } = xl(e), a = r.find((e) => Z(e, "topNode"))?.name;
	return new je({
		topNode: a,
		nodes: Object.fromEntries(r.map((r) => {
			let i = n.filter((e) => e.type === r.name), a = {
				...
				attrs: Object.fromEntries(i.map(Al))
			}), s = Q(Z(r, "parseHTML", a));
			s && (o.parseDOM = s.map((e) => Ol(e, i)));
			let c = Z(r, "renderHTML", a);
			c && (o.toDOM = (e) => c({
				node: e,
				HTMLAttributes: El(e, i)
			}));
...
function Pl(e) {
	let t = Nl(_l(e)), n = Ml(t.map((e) => e.name));
...
function Il(e, t) {
	let n = Fl(t);
	return vl(C.fromJSON(n, e).content, n);
}
function Ll(e, t) {
	let n = Fl(t), r = Ac(e);
	return Fe.fromSchema(n).parse(r).toJSON();
}
function Rl(e, t, n) {
...
function Vl(e, t, n) {
	let { blockSeparator: r = "\n\n", textSerializers: i = {} } = n || {}, a = Fl(t);
	return zl(C.fromJSON(a, e), {
		blockSeparator: r,
		textSerializers: {
			...Bl(a),
			...i
...
function Ul(e, t) {
	let n = $c(typeof t == "string" ? t : t.name, e.schema);
	return n === "node" ? Hl(e, t) : n === "mark" ? dl(e, t) : {};
}
function Wl(e, t = JSON.stringify) {
	let n = {};
	return e.filter((e) => {
		let r = t(e);
...
function ql(e, t = 0) {
	...
	return Object.keys(o).length && (s.attrs = o), a.length && (s.marks = a), e.content.childCount && (s.content = [], e.forEach((e, r) => {
		var i;
		(i = s.content) == null || i.push(ql(e, t + r + n));
	})), e.text && (s.text = e.text), s;
}
function Jl(e, t, n) {
	let r = [];
	return e === t ? n.resolve(e).marks().forEach((t) => {
		let i = vc(n.resolve(e), t.type);
		i && r.push({
			mark: t,
			...i
		});
...
function $l(e, t, n = {}) {
	...
	if (r) return !!(e.storedMarks || e.selection.$from.marks()).filter((e) => !a || a.name === e.type.name).find((e) => hc(e.attrs, n, { strict: !1 }));
	let o = 0, s = [];
	...
	let c = s.filter((e) => !a || a.name === e.mark.type.name).filter((e) => hc(e.mark.attrs, n, { strict: !1 })).reduce((e, t) => e + t.to - t.from, 0), l = s.filter((e) => !a || e.mark.type !== a && e.mark.type.excludes(a)).reduce((e, t) => e + t.to - t.from, 0);
	return (c > 0 ? c + l : c) >= o;
}
function eu(e, t, n = {}) {
	if (!t) return Jc(e, null, n) || $l(e, null, n);
	let r = $c(t, e.schema);
	return r === "node" ? Jc(e, t, n) : r === "mark" && $l(e, t, n);
}
var tu = (e, t) => {
	let { $from: n, $to: r, $anchor: i } = e.selection;
	if (t) {
		let n = gl((e) => e.type.name === t)(e.selection);
		if (!n) return !1;
...
function iu(e, t) {
	let { nodeExtensions: n } = xl(t), r = n.find((t) => t.name === e);
	if (!r) return !1;
	let i = Q(Z(r, "group", {
		name: r.name,
		options: r.options,
...
function au(e, { checkChildren: t = !0, ignoreWhitespace: n = !1 } = {}) {
	if (n) {
...
function su({ selection: e, pos: t, nodeSize: n, selectedOnTextSelection: r = !1 }) {
	let { from: i, to: a } = e;
	return !!(i <= t && a >= t + n || r && xc(e) && i > t && a < t + n);
}
var cu = class e {
	constructor(e) {
		this.position = e;
...
var hu = (e, t = {}) => ({ tr: n, state: r, dispatch: i }) => {
	...
	return mu(r, n, c);
}, gu = (e, t) => ({ tr: n }) => (n.setMeta(e, t), !0), _u = (e, t = {}) => ({ state: n, dispatch: r, chain: i }) => {
	...
	return !0;
}, xu = (e) => ({ state: t, dispatch: n }) => Cr(J(e, t.schema))(t, n);
function Su(e, t) {
...
var Cu = ({ keepMarks: e = !0 } = {}) => ({ tr: t, state: n, dispatch: r, editor: i }) => {
	let { selection: a, doc: o } = t, { $from: s, $to: c } = a, l = i.extensionManager.attributes, u = Zl(l, s.node().type.name, s.node().attrs);
	if (a instanceof A && a.node.isBlock) return !s.parentOffset || !Lt(o, s.pos) ? !1 : (r && (e && Su(n, i.extensionManager.splittableMarks), t.split(s.pos).scrollIntoView()), !0);
	if (!s.parent.isBlock) return !1;
	let d = c.parentOffset === c.parent.content.size, f = s.depth === 0 ? void 0 : Fc(s.node(-1).contentMatchAt(s.indexAfter(-1))), p = d && f ? [{
		type: f,
		attrs: u
	}] : void 0, m = Lt(t.doc, t.mapping.map(s.pos), 1, p);
	if (!p && !m && Lt(t.doc, t.mapping.map(s.pos), 1, f ? [{ type: f }] : void 0) && (m = !0, p = f ? [{
		type: f,
		attrs: u
	}] : void 0), r) {
		...
		e && Su(n, i.extensionManager.splittableMarks), t.scrollIntoView();
	}
	return m;
}, wu = (e, t = {}) => ({ tr: n, state: r, dispatch: i, editor: o }) => {
	...
	if (c.parent.content.size === 0 && c.node(-1).childCount === c.indexAfter(-1)) {
		...
		if (i) {
			...
			let i = c.indexAfter(-1) < c.node(-2).childCount ? 1 : c.indexAfter(-2) < c.node(-3).childCount ? 2 : 3, o = {
				...Zl(p, c.node().type.name, c.node().attrs),
				...t
...
var Du = (e, t) => {
	let n = gl((e) => e.type === t)(e.selection);
	if (!n) return !0;
	let r = e.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
	if (r === void 0) return !0;
	let i = e.doc.nodeAt(r);
	return !(n.node.type === i?.type && zt(e.doc, n.pos)) || !Eu(n.node.attrs.type, i?.attrs.type) || e.join(n.pos), !0;
}, Ou = (e, t) => {
	let n = gl((e) => e.type === t)(e.selection);
	if (!n) return !0;
	...
	if (r === void 0) return !0;
	let i = e.doc.nodeAt(r);
	return !(n.node.type === i?.type && zt(e.doc, r)) || !Eu(n.node.attrs.type, i?.attrs.type) || e.join(r), !0;
};
function ku(e) {
...
var Au = (e, t, n, r = {}) => ({ editor: i, tr: a, state: o, dispatch: s, chain: c, commands: l, can: u }) => {
	...
	if (!y) return !1;
	let x = gl((e) => iu(e.type.name, d))(h), S = h.from === 0 && h.to === o.doc.content.size, ee = o.doc.content.content, te = ee.length === 1 ? ee[0] : null, ne = S && te && iu(te.type.name, d) ? {
		node: te,
		pos: 0,
		depth: 0
	...
	if ((ie || ae) && re) {
		...
		if (iu(re.node.type.name, d) && p.validContent(re.node.content)) return c().command(() => (a.setNodeMarkup(re.pos, p), !0)).command(() => Du(a, p)).command(() => Ou(a, p)).run();
	}
	return !n || !b || !s ? c().command(() => u().wrapInList(p, r) ? !0 : l.clearNodes()).wrapInList(p, r).command(() => Du(a, p)).command(() => Ou(a, p)).run() : c().command(() => {
		let e = u().wrapInList(p, r), t = b.filter((e) => f.includes(e.type.name));
		return a.ensureMarks(t), e ? !0 : l.clearNodes();
	}).wrapInList(p, r).command(() => Du(a, p)).command(() => Ou(a, p)).run();
}, ju = (e, t = {}, n = {}) => ({ state: r, commands: i }) => {
	let { extendEmptyMarkRange: a = !1 } = n, o = Y(e, r.schema);
	return $l(r, o, t) ? i.unsetMark(o, { extendEmptyMarkRange: a }) : i.setMark(o, t);
}, Mu = (e, t, n = {}) => ({ state: r, commands: i }) => {
	let a = J(e, r.schema), o = J(t, r.schema), s = Jc(r, a, n), c;
	return r.selection.$anchor.sameParent(r.selection.$head) && (c = r.selection.$anchor.parent.attrs), s ? i.setNode(o, c) : i.setNode(a, {
		...c,
		...n
	});
}, Nu = (e, t = {}) => ({ state: n, commands: r }) => {
	let i = J(e, n.schema);
	return Jc(n, i, t) ? r.lift(i) : r.wrapIn(i, t);
...
}, zu = (e, t = {}) => ({ state: n, dispatch: r }) => ur(J(e, n.schema), t)(n, r), Bu = (e, t = {}) => ({ state: n, dispatch: r }) => _r(J(e, n.schema), t)(n, r), Vu = class {
	constructor() {
		this.callbacks = {};
	}
	on(e, t) {
...
function Qu(e) {
	return Zu(e) === "Object" && e.constructor === Object && Object.getPrototypeOf(e) === Object.prototype;
}
function $u(e) {
...
Ys(ed, {
	...
	createBlockMarkdownSpec: () => id,
	createInlineMarkdownSpec: () => sd,
	parseAttributes: () => td,
	parseIndentedBlocks: () => cd,
	renderNestedMarkdownContent: () => ld,
	serializeAttributes: () => nd
});
function td(e) {
	if (!e?.trim()) return {};
...
function rd(e) {
	let { nodeName: t, name: n, parseAttributes: r = td, serializeAttributes: i = nd, defaultAttributes: a = {}, requiredAttributes: o = [], allowedAttributes: s } = e, c = n || t, l = (e) => {
		if (!s) return e;
		let t = {};
		return s.forEach((n) => {
			n in e && (t[n] = e[n]);
...
function id(e) {
	let { nodeName: t, name: n, getContent: r, parseAttributes: i = td, serializeAttributes: a = nd, defaultAttributes: o = {}, content: s = "block", allowedAttributes: c } = e, l = n || t, u = (e) => {
		if (!c) return e;
		let t = {};
		return c.forEach((n) => {
			n in e && (t[n] = e[n]);
...
function sd(e) {
	let { nodeName: t, name: n, getContent: r, parseAttributes: i = ad, serializeAttributes: a = od, defaultAttributes: o = {}, selfClosing: s = !1, allowedAttributes: c } = e, l = n || t, u = (e) => {
		if (!c) return e;
		let t = {};
		return c.forEach((n) => {
...
function dd(e, t) {
	...
	return e.every((e) => {
		let r = ud(e), i = t.findIndex((t, i) => !n[i] && r === ud(t) && Hu(e.attrs, t.attrs));
		return i !== -1 && (n[i] = !0, !0);
	});
}
function fd(e, t) {
	let n = { ...e };
	return Qu(e) && Qu(t) && Object.keys(t).forEach((r) => {
		Qu(t[r]) && Qu(e[r]) ? n[r] = fd(e[r], t[r]) : n[r] = t[r];
	}), n;
}
function pd(e, t, n = {}) {
...
function _d(e) {
	...
	return a.forEach((e) => {
		...
		let f = s.state.tr, p = Xs({
			state: s.state,
			transaction: f
		}), m = {
			from: n - (a[0].length - i.length),
			to: r
		}, { commands: h, chain: g, can: _ } = new Zs({
			editor: t,
			state: p
		});
		e.handler({
...
function vd(e) {
	let { editor: t, rules: n } = e, r = new M({
		state: {
			init() {
				return null;
			},
			apply(e, i, o) {
				...
				return c && setTimeout(() => {
					let { text: e } = c;
					e = typeof e == "string" ? e : vl(a.from(e), o.schema);
...
function Cd(e) {
	let { editor: t, state: n, from: r, to: i, rule: a, pasteEvent: o, dropEvent: s } = e, { commands: c, chain: l, can: u } = new Zs({
		editor: t,
		state: n
	}), d = [];
...
function Ed(e) {
	...
	return n.map((e) => new M({
		...
		appendTransaction: (t, n, r) => {
			...
			if (p) {
				let { text: t } = f;
				t = typeof t == "string" ? t : vl(a.from(t), r.schema);
...
var Dd = class {
	constructor(e, t) {
		this.splittableMarks = [], this.nonClearableMarks = [], this.editor = t, this.baseExtensions = e, this.extensions = Pl(e), this.schema = jl(this.extensions, t), this.setupExtensions();
	}
	get commands() {
	...
	get plugins() {
		let { editor: e } = this;
		return Nl([...this.extensions].reverse()).flatMap((t) => {
			let n = {
				name: t.name,
				options: t.options,
				storage: this.editor.extensionStorage[t.name],
			...
			if (t.type === "mark" && Z(t, "exitable", n) && (a.ArrowRight = () => bd.handleExit({
				editor: e,
				mark: t
			})), i) {
	...
	get nodeViews() {
		let { editor: e } = this, { nodeExtensions: t } = xl(this.extensions);
	...
	dispatchTransaction(e) {
		let { editor: t } = this;
		return Nl([...this.extensions].reverse()).reduceRight((e, n) => {
			let r = {
				name: n.name,
				options: n.options,
				storage: this.editor.extensionStorage[n.name],
				editor: t,
				type: Xl(n.name, this.schema)
	...
	transformPastedHTML(e) {
		let { editor: t } = this;
		return Nl([...this.extensions]).reduce((e, n) => {
			let r = {
				name: n.name,
				options: n.options,
				storage: this.editor.extensionStorage[n.name],
	...
	get markViews() {
		let { editor: e } = this, { markExtensions: t } = xl(this.extensions);
	...
	setupExtensions() {
		...
		this.editor.extensionStorage = Object.fromEntries(e.map((e) => [e.name, e.storage])), e.forEach((e) => {
			...
			e.type === "mark" && ((Q(Z(e, "keepOnSplit", t)) ?? !0) && this.splittableMarks.push(e.name), (Q(Z(e, "clearable", t)) ?? !0) || this.nonClearableMarks.push(e.name));
...
Dd.resolve = Pl, Dd.sort = Nl, Dd.flatten = _l;
var Od = {};
Ys(Od, {
	...
	Tabindex: () => Rd,
	TextDirection: () => zd,
	focusEventsPluginKey: () => Pd
});
var $ = class e extends yd {
	constructor() {
	...
	addProseMirrorPlugins() {
		return [new M({
			key: new Nn("clipboardTextSerializer"),
			props: { clipboardTextSerializer: () => {
				let { editor: e } = this, { state: t, schema: n } = e, { doc: r, selection: i } = t, a = Bl(n), { blockSeparator: o } = this.options, s = {
...
}), Pd = new Nn("focusEvents"), Fd = $.create({
	name: "focusEvents",
	addProseMirrorPlugins() {
		let { editor: e } = this;
		return [new M({
	...
	addGlobalAttributes() {
		...
		let { nodeExtensions: e } = xl(this.extensions);
		return [{
	...
	constructor(e = {}) {
		super(), this.css = null, this.className = "tiptap", this.editorView = null, this.isFocused = !1, this.destroyed = !1, this.isInitialized = !1, this.extensionStorage = {}, this.instanceId = Math.random().toString(36).slice(2, 9), this.options = {
			...
			getUpdatedPosition: lu,
			createMappablePosition: uu
		...
		if (!this.editorState) {
			let e = Sc(t, this.options.autofocus);
			this.editorState = kn.create({
				doc: t,
				schema: this.schema,
				selection: e || void 0
			});
	...
	injectCSS() {
		this.options.injectCSS && typeof document < "u" && (this.css = Wu(Vd, this.options.injectNonce));
	}
	setOptions(e = {}) {
		this.options = {
			...this.options,
	...
	createExtensionManager() {
		let e = [...this.options.enableCoreExtensions ? [
			Nd,
			kd.configure({ blockSeparator: this.options.coreExtensionOptions?.clipboardTextSerializer?.blockSeparator }),
			Ad,
			Fd,
			Id,
			Rd.configure({ value: this.options.coreExtensionOptions?.tabindex?.value }),
			Md,
			Ld,
			jd,
			zd.configure({ direction: this.options.textDirection })
	...
	createCommandManager() {
		this.commandManager = new Zs({ editor: this });
	}
	createSchema() {
	...
	createDoc() {
		let e;
		try {
			e = ll(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: this.options.enableContentCheck });
		} catch (e) {
			if (!(e instanceof Error) || !["[tiptap error]: Invalid JSON content", "[tiptap error]: Invalid HTML content"].includes(e.message)) throw e;
			let t = ll(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: !1 });
			return this.editorState = kn.create({
				doc: t,
				schema: this.schema,
				selection: Sc(t, this.options.autofocus) || void 0
	...
	return new hd({
		...
		handler: ({ state: t, range: n, match: r }) => {
			...
			if (o) {
				...
				if (Jl(n.from, n.to, t.doc).filter((t) => t.mark.type.excluded.find((n) => n === e.type && n !== t.mark.type)).filter((e) => e.to > c).length) return null;
...
function qd(e) {
	return new hd({
		...
		handler: ({ state: t, range: n, match: r, chain: i }) => {
			let a = Q(e.getAttributes, void 0, r) || {}, o = t.tr.delete(n.from, n.to), s = o.doc.resolve(n.from).blockRange(), c = s && Dt(s, e.type, a);
			if (!c) return null;
...
var Yd = (e, t) => {
	...
	handleResizeStart(e, t) {
		e.preventDefault(), e.stopPropagation(), this.isResizing = !0, this.activeHandle = t, Xd(e) ? (this.startX = e.touches[0].clientX, this.startY = e.touches[0].clientY) : (this.startX = e.clientX, this.startY = e.clientY), this.startWidth = this.element.offsetWidth, this.startHeight = this.element.offsetHeight, this.startWidth > 0 && this.startHeight > 0 && (this.aspectRatio = this.startWidth / this.startHeight), this.getPos(), this.container.dataset.resizeState = "true", this.classNames.resizing && this.container.classList.add(this.classNames.resizing), document.addEventListener("mousemove", this.handleMouseMove), document.addEventListener("touchmove", this.handleTouchMove), document.addEventListener("mouseup", this.handleMouseUp), document.addEventListener("keydown", this.handleKeyDown), document.addEventListener("keyup", this.handleKeyUp);
	}
	handleResize(e, t) {
	...
	return new xd({
		...
		handler: ({ state: t, range: n, match: r, pasteEvent: i }) => {
			...
			if (s) {
				...
				if (Jl(n.from, n.to, t.doc).filter((t) => t.mark.type.excluded.find((n) => n === e.type && n !== t.mark.type)).filter((e) => e.to > u).length) return null;
...
//#endregion
export { dl as $, td as $t, qu as A, Gc as At, gl as B, $u as Bt, id as C, O as Cn, tu as Ct, uu as D, a as Dn, Yu as Dt, sd as E, Gt as En, ru as Et, Gu as F, su as Ft, Ll as G, ed as Gt, _l as H, wc as Ht, Od as I, Xu as It, Sl as J, fd as Jt, Vl as K, dd as Kt, pl as L, Qu as Lt, el as M, Jc as Mt, Ac as N, au as Nt, jc as O, d as On, yl as Ot, Ju as P, ou as Pt, vl as Q, hc as Qt, ml as R, mc as Rt, rd as S, Nn as Sn, Cc as St, ll as T, pt as Tn, bl as Tt, Dl as U, Ud as Ut, hl as V, xc as Vt, Il as W, tf as Wt, ql as X, Wd as Xt, Kl as Y, X as Yt, Z, nf as Zt, Hu as _, qs as _n, lu as _t, Jd as a, Pl as an, J as at, fl as b, A as bn, vd as bt, bd as c, Mc as cn, jl as ct, Bd as d, xl as dn, Zl as dt, cd as en, vc as et, ef as f, Kd as fn, Ku as ft, af as g, qd as gn, Bl as gt, Qd as h, pd as hn, Ql as ht, $ as i, ld as in, Hl as it, Fc as j, $l as jt, Wu as k, iu as kt, md as l, nd as ln, Xl as lt, Zd as m, Gd as mn, Rl as mt, Hd as n, du as nn, Jl as nt, hd as o, Sc as on, El as ot, xd as p, rf as pn, zl as pt, Ul as q, Tl as qt, yd as r, Wl as rn, Yl as rt, cu as s, pu as sn, Fl as st, Zs as t, Ed as tn, Y as tt, $d as u, Nl as un, $c as ut, Q as v, Ko as vn, Yd as vt, Xs as w, k as wn, nu as wt, Qs as x, M as xn, eu as xt, Uu as y, G as yn, Ol as yt, Ml as z, Tc as zt };
