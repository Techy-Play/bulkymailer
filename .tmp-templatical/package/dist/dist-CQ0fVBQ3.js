...
var r = {
	...
	level: 2,
	textAlign: "left"
}, i = { content: "<p>Enter your text here</p>" }, a = {
	src: "",
	alt: "",
	width: "full",
	align: "center"
...
function y(e, t) {
	...
	for (let r of Object.keys(t)) {
		let i = e[r], a = t[r];
		a !== void 0 && (n[r] = v(i) && v(a) ? y(i, a) : a);
	}
	return n;
}
function b(e = "Arial", t) {
	return {
		blocks: [],
		settings: {
			..._,
...
function x(e, t) {
	return !t || Object.keys(t).length === 0 ? e : y(e, t);
}
function S() {
...
function ne(e) {
	let t = {};
	for (let n of e.fields) t[n.key] = te(n);
	let n = x(C(), e.defaultStyles);
	return {
		id: S(),
		type: "custom",
		customType: e.type,
...
function re(e, t) {
	switch (e) {
		case "section": return k(t?.section);
		case "title": return w(t?.title);
		case "paragraph": return T(t?.paragraph);
		case "image": return E(t?.image);
		case "button": return D(t?.button);
		case "divider": return O(t?.divider);
		case "video": return A(t?.video);
		case "social": return j(t?.social);
		case "spacer": return M(t?.spacer);
		case "html": return N(t?.html);
		case "menu": return P(t?.menu);
		case "table": return I(t?.table);
		case "countdown": return L(t?.countdown);
		default: throw Error(`Unknown block type: ${e}`);
	}
}
function R(e) {
	let t = JSON.parse(JSON.stringify(e));
	return t.id = S(), t.type === "section" && (t.children = t.children.map((e) => e.map((e) => R(e)))), t;
}
function z(e) {
...
function U(e) {
	for (let t of Object.keys(B)) if (B[t].value.source === e.value.source) return V[t];
	return null;
}
function W(e) {
	for (let t of Object.keys(B)) if (B[t].value.source === e.value.source) return H[t];
	return null;
}
function G(e) {
	return e ? typeof e == "string" ? B[e] ?? B.liquid : e : B.liquid;
}
function K(e) {
...
function q(e, t) {
	let n = e?.trim() || "";
	return !K(t.logic).test(n) && K(t.value).test(n);
}
function J(e, t) {
...
function Y(e, t) {
	return $(e, "data-merge-tag", (e) => J(e, t));
}
function X(e, t) {
	return t.find((t) => t.value === e)?.sample;
}
function ie(e, t) {
	return $(e, "data-merge-tag", (e) => se(X(e, t) ?? J(e, t)), { unwrap: (e) => X(e, t) !== void 0 });
}
function ae(e) {
...
//#endregion
export { U as A, ie as B, w as C, J as D, Q as E, ue as F, le as I, Y as L, n as M, Z as N, X as O, q as P, G as R, I as S, S as T, oe as V, P as _, B as a, j as b, ce as c, L as d, ne as f, E as g, N as h, t as i, ae as j, W as k, re as l, O as m, _ as n, de as o, b as p, e as r, R as s, g as t, D as u, T as v, A as w, M as x, k as y, z };
