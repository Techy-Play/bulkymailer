//#region src/i18n/locales/cloud/pt-BR.ts
var e = {
	loading: { initializing: "Inicializando..." },
	error: {
		title: "Algo deu errado",
		defaultMessage: "O editor não conseguiu se conectar ao Templatical. Verifique sua conexão de rede e tente novamente.",
		authFailed: "Falha na autenticação. Verifique suas credenciais.",
		templateNotFound: "O template solicitado não foi encontrado. Verifique se o ID do template está correto.",
	...
	aiChat: {
		...
		applyFailed: "Não foi possível aplicar as alterações ao template. Tente novamente.",
		revert: "Reverter alterações",
		reapply: "Reaplicar alterações",
		error: "Falha ao gerar o template",
		clear: "Limpar conversa",
		placeholder: "Descreva o template de e-mail que você deseja criar, ou peça para modificar o atual.",
	...
	scoring: {
		...
		emptyState: "Pontue seu template para obter sugestões práticas sobre risco de spam, legibilidade, acessibilidade e boas práticas."
	},
	aiMenu: {
	...
	comments: {
		...
		noCommentsHint: "Inicie uma conversa adicionando um comentário ao template ou a um bloco específico.",
	...
	designReference: {
		...
		promptPlaceholder: "Descreva ajustes ou preferências para o template gerado...",
		generate: "Gerar a partir do design",
		generating: "Analisando design e gerando template...",
		replaceWarning: "Gerar a partir de uma referência de design substituirá o conteúdo existente do template.",
		...
		invalidFileType: "Este tipo de arquivo não é suportado. Envie um PNG, JPG, WebP ou PDF."
	},
	saveGate: {
...
//# sourceMappingURL=pt-BR-CTzHTqJD.js.map