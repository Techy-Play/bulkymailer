...
var e = {
	...
	blockActions: {
		...
		dragLifted: "Moviendo {block}. Usa las flechas arriba y abajo para reposicionar, Espacio o Intro para soltar, Esc para cancelar.",
	...
	image: {
		...
		placeholderUrlTooltip: "Dado que la URL de la imagen utiliza una etiqueta de combinación, puedes proporcionar una imagen real aquí para previsualizar el diseño mientras diseñas. Esto no se incluirá en el resultado final.",
		...
		decorativeHint: "Oculto para los lectores de pantalla. Utilízalo solo para espaciadores y adornos visuales."
	},
	video: {
		...
		placeholderUrlPlaceholder: "https://... (solo para diseño)",
		placeholderUrlTooltip: "Dado que la URL del vídeo utiliza una etiqueta de combinación, puedes proporcionar una miniatura real aquí para previsualizar el diseño mientras diseñas. Esto no se incluirá en el resultado final.",
	...
	customBlocks: {
		...
		renderError: "No se pudo renderizar este bloque. Comprueba si hay errores en la plantilla del bloque.",
		fields: {
		...
		toolbar: { noDefinition: "Registra este tipo de bloque en la configuración de tu SDK para editar sus propiedades" },
		dataSource: {
	...
	html: {
		...
		sanitizationHint: "El HTML se exporta tal cual y no se sanea — asegúrate de que el contenido sea seguro."
	},
	blockSettings: {
		spacing: "Espaciado",
		padding: "Relleno",
	...
	templateSettings: {
		...
		preheaderTextPlaceholder: "Texto de vista previa que se muestra después del asunto en la bandeja de entrada...",
		preheaderTextHint: "Este texto aparece después del asunto en las vistas previas de los clientes de correo electrónico. Admite etiquetas de combinación.",
		language: "Idioma",
		contentLocale: "Idioma del contenido",
		contentLocaleHint: "Código BCP 47 (por ejemplo, es, en, de). Establece el atributo lang del correo electrónico renderizado para que los lectores de pantalla pronuncien el contenido correctamente.",
		tips: "Consejos",
	...
	canvas: {
		...
		aiHintDesign: "¿Tienes un diseño existente? Sube una captura de pantalla, imagen o PDF y",
	...
	mediaLibrary: {
		...
		deleteWarningMessage: "Este archivo se eliminará permanentemente y no se podrá recuperar.",
		deleteWarningUsageNote: "Los siguientes archivos se usan en plantilles. Eliminarlos puede romper esas plantilles.",
		...
		replaceWarningMessage: "Estás a punto de reemplazar este archivo. El reemplazo debe tener la misma extensión de archivo ({extension}).",
		replaceWarningUsageNote: "Este archivo se usa en {count} plantilla(s). Reemplazarlo actualizará todas las referencias.",
	...
	savedBlocks: {
		...
		reorderHint: "Arrastra para reordenar: los bloques se guardan en este orden",
	...
	previewResolution: {
		...
		failed: "No se pudo resolver la vista previa; se muestra la plantilla sin resolver.",
	...
	testEmail: {
		...
		previewHint: "Las etiquetas de combinación se muestran sin resolver — tu backend las rellena.",
		previewHintSample: "Las etiquetas de combinación muestran valores de ejemplo; tu backend inserta los datos reales.",
		recipientNotAllowed: "Esa dirección no está en la lista de destinatarios permitidos.",
		send: "Enviar",
		sending: "Enviando...",
		cancel: "Cancelar",
	...
	smallScreen: {
		...
		message: "El editor necesita más espacio del que ofrece esta pantalla. Ábrelo en una tableta o computadora de escritorio para comenzar a editar."
	}
};
//#endregion
export { e as default };

//# sourceMappingURL=es-Cuss2snv.js.map