...
var m = {
	...
	level: 2,
	textAlign: "left"
}, h = { content: "<p>Enter your text here</p>" }, g = {
	src: "",
	alt: "",
	width: "full",
	align: "center"
...
function k(e, t) {
	...
	for (let r of Object.keys(t)) {
		let i = e[r], a = t[r];
		a !== void 0 && (n[r] = O(i) && O(a) ? k(i, a) : a);
	}
	return n;
}
//#endregion
//#region ../types/src/template.ts
function ne(e = "Arial", t) {
	return {
		blocks: [],
		settings: {
			...D,
...
function A(e, t) {
	return !t || Object.keys(t).length === 0 ? e : k(e, t);
}
function j() {
...
function oe(e) {
	let t = {};
	for (let n of e.fields) t[n.key] = ae(n);
	let n = A(M(), e.defaultStyles);
	return {
		id: j(),
		type: "custom",
		customType: e.type,
...
function K(e, t) {
	switch (e) {
		case "section": return R(t?.section);
		case "title": return N(t?.title);
		case "paragraph": return P(t?.paragraph);
		case "image": return F(t?.image);
		case "button": return I(t?.button);
		case "divider": return L(t?.divider);
		case "video": return z(t?.video);
		case "social": return B(t?.social);
		case "spacer": return V(t?.spacer);
		case "html": return H(t?.html);
		case "menu": return U(t?.menu);
		case "table": return W(t?.table);
		case "countdown": return G(t?.countdown);
		default: throw Error(`Unknown block type: ${e}`);
	}
}
function q(e) {
	let t = JSON.parse(JSON.stringify(e));
	return t.id = j(), t.type === "section" && (t.children = t.children.map((e) => e.map((e) => q(e)))), t;
}
//#endregion
...
function ue(e) {
	for (let t of Object.keys(J)) if (J[t].value.source === e.value.source) return ce[t];
	return null;
}
function de(e) {
	for (let t of Object.keys(J)) if (J[t].value.source === e.value.source) return le[t];
	return null;
}
function fe(e) {
	return e ? typeof e == "string" ? J[e] ?? J.liquid : e : J.liquid;
}
function Y(e) {
...
function pe(e, t) {
	let n = e?.trim() || "";
	return !Y(t.logic).test(n) && Y(t.value).test(n);
}
function X(e, t) {
...
function me(e, t) {
	return $(e, "data-merge-tag", (e) => X(e, t));
}
function Z(e, t) {
	return t.find((t) => t.value === e)?.sample;
}
function he(e, t) {
	return $(e, "data-merge-tag", (e) => ve(Z(e, t) ?? X(e, t)), { unwrap: (e) => Z(e, t) !== void 0 });
}
function ge(e) {
	return e.some((e) => e.sample !== void 0);
}
function _e(e, t) {
	if (!e) return e;
	let n = e;
	for (let e of t) e.sample !== void 0 && (n = n.split(e.value).join(e.sample));
	return n;
}
function ve(e) {
...
function xe(e, t) {
	return $(e, "data-logic-merge-tag", (e) => Q(e, t));
}
function $(e, t, n, r) {
	let i = RegExp(`(?:^|\\s)${t}="([^"<>]*)"`), a = "", o = 0;
	for (; o < e.length;) {
		let t = e.indexOf("<span", o);
		if (t === -1) {
			a += e.substring(o);
			break;
		}
		...
		let l = e.indexOf("</span>", c + 1);
		if (l === -1) {
			a += e.substring(o);
			break;
		}
		let u = e.substring(t + 5, c), d = i.exec(u);
		if (!d) {
			a += e.substring(o, t + 5), o = t + 5;
			continue;
		}
		let f = d[1], p = n(f);
		r?.unwrap?.(f) ? (a += e.substring(o, t), a += p) : (a += e.substring(o, c + 1), a += p, a += "</span>"), o = l + 7;
	}
	return a;
}
//#endregion
//#region ../types/src/preview-resolution.ts
function Se(e) {
	return typeof e != "object" || !e ? !1 : Array.isArray(e.blocks);
}
//#endregion
...
//#endregion
export { e as $, B as A, ee as B, oe as C, U as D, F as E, j as F, i as G, d as H, ne as I, u as J, n as K, te as L, W as M, N, P as O, z as P, t as Q, D as R, G as S, H as T, a as U, s as V, f as W, r as X, p as Y, c as Z, _e as _, Q as a, K as b, de as c, be as d, pe as f, he as g, fe as h, ye as i, V as j, R as k, ue as l, me as m, Se as n, X as o, xe as p, l as q, J as r, Z as s, Ce as t, ge as u, se as v, L as w, I as x, q as y, o as z };

//# sourceMappingURL=src-CZjSXPYq.js.map