...
var e = {
	...
	image: {
		...
		placeholderUrlTooltip: "Since the image URL uses a merge tag, you can provide a real image here to preview the layout while designing. This is not included in the final output.",
		clickToAdd: "Click to add image URL",
		browseMedia: "Browse Media",
		dropToUpload: "Drop image to upload",
		uploading: "Uploading…",
		decorative: "Decorative image",
		decorativeHint: "Hidden from screen readers. Use only for spacers and visual flourishes."
	},
	video: {
		videoUrl: "Video URL",
		...
		placeholderUrlPlaceholder: "https://... (design-time only)",
		placeholderUrlTooltip: "Since the video URL uses a merge tag, you can provide a real thumbnail here to preview the layout while designing. This is not included in the final output.",
	...
	customBlocks: {
		...
		renderError: "This block could not be rendered. Check the block template for errors.",
		fields: {
			required: "Required",
			addItem: "Add item",
			removeItem: "Remove",
		...
		toolbar: { noDefinition: "Register this block type in your SDK configuration to edit its properties" },
		dataSource: {
	...
	html: {
		...
		sanitizationHint: "HTML is exported as-is and isn't sanitized — make sure the content is safe."
	},
	blockSettings: {
		spacing: "Spacing",
		padding: "Padding",
	...
	templateSettings: {
		...
		preheaderTextPlaceholder: "Preview text shown after subject line in inbox...",
		preheaderTextHint: "This text appears after the subject line in email client previews. Supports merge tags.",
		language: "Language",
		contentLocale: "Content language",
		contentLocaleHint: "BCP 47 code (e.g. en, de, pt-BR). Sets the rendered email's lang attribute so screen readers pronounce content correctly.",
		tips: "Tips",
	...
	canvas: {
		...
		aiHintDesign: "Have an existing design? Upload a screenshot, image, or PDF and",
	...
	mediaLibrary: {
		...
		deleteWarningMessage: "This file will be permanently deleted and cannot be recovered.",
	...
	testEmail: {
		...
		preview: "Preview",
		previewHint: "Merge tags are shown unresolved — your backend fills them in.",
		previewHintSample: "Merge tags show example values — your backend fills in the real data.",
	...
	smallScreen: {
		...
		message: "The editor needs more space than this screen offers. Open it on a tablet or desktop to start editing."
	}
};
//#endregion
export { e as default };

//# sourceMappingURL=en-DlqX2YWZ.js.map