...
var e = {
	...
	blockActions: {
		...
		dragLifted: "Movent {block}. Utilitza les fletxes amunt i avall per reposicionar, Espai o Retorn per deixar anar, Esc per cancel·lar.",
	...
	image: {
		...
		placeholderUrlTooltip: "Com que la URL de la imatge utilitza una etiqueta de fusió, podeu proporcionar una imatge real aquí per previsualitzar el disseny mentre dissenyeu. Això no s'inclou a la sortida final.",
		...
		decorativeHint: "Ocult per als lectors de pantalla. Utilitzeu-lo només per a espaiadors i detalls visuals."
	},
	video: {
		...
		placeholderUrlPlaceholder: "https://... (només per al disseny)",
		placeholderUrlTooltip: "Com que la URL del vídeo utilitza una etiqueta de fusió, podeu proporcionar una miniatura real aquí per previsualitzar el disseny mentre dissenyeu. Això no s'inclou a la sortida final.",
	...
	customBlocks: {
		...
		renderError: "No s'ha pogut renderitzar aquest bloc. Comproveu si hi ha errors a la plantilla del bloc.",
		fields: {
			required: "Obligatori",
			addItem: "Afegeix un element",
			removeItem: "Elimina",
		...
		toolbar: { noDefinition: "Enregistreu aquest tipus de bloc a la configuració de l'SDK per editar-ne les propietats" },
		dataSource: {
	...
	html: {
		...
		sanitizationHint: "L'HTML s'exporta tal qual i no es depura — assegura't que el contingut sigui segur."
	},
	blockSettings: {
		spacing: "Espaiat",
		padding: "Farciment",
	...
	templateSettings: {
		...
		preheaderTextPlaceholder: "Text de vista prèvia que es mostra després de la línia de l'assumpte a la bústia...",
		preheaderTextHint: "Aquest text apareix després de la línia de l'assumpte a les vistes prèvies dels clients de correu. Admet etiquetes de fusió.",
		language: "Idioma",
	...
	canvas: {
		...
		aiHintDesign: "Teniu un disseny existent? Pugeu una captura de pantalla, una imatge o un PDF i",
	...
	mediaLibrary: {
		...
		deleteWarningMessage: "Aquest fitxer s'eliminarà permanentment i no es podrà recuperar.",
		deleteWarningUsageNote: "Els fitxers següents s'utilitzen en plantilles. Eliminar-los pot trencar aquestes plantilles.",
		...
		replaceWarningMessage: "Esteu a punt de substituir aquest fitxer. El substitut ha de tenir la mateixa extensió de fitxer ({extension}).",
		replaceWarningUsageNote: "Aquest fitxer s'utilitza en {count} plantilla/es. Substituir-lo actualitzarà totes les referències.",
	...
	savedBlocks: {
		...
		emptyHint: "Desa blocs de les teves plantilles per reutilitzar-los més tard.",
	...
	previewResolution: {
		...
		failed: "No s’ha pogut resoldre la vista prèvia; es mostra la plantilla sense resoldre.",
	...
	testEmail: {
		...
		previewHintSample: "Les etiquetes de combinació mostren valors d’exemple; el teu backend insereix les dades reals.",
	...
	smallScreen: {
		...
		message: "L'editor necessita més espai del que ofereix aquesta pantalla. Obriu-lo en una tauleta o ordinador d'escriptori per començar a editar."
	}
};
//#endregion
export { e as default };

//# sourceMappingURL=ca-D1zgI9fQ.js.map