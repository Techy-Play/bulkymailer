//#region src/i18n/locales/cloud/de.ts
var e = {
	loading: { initializing: "Initialisieren..." },
	error: {
		title: "Etwas ist schiefgelaufen",
		defaultMessage: "Der Editor konnte keine Verbindung zu Templatical herstellen. Überprüfen Sie Ihre Netzwerkverbindung und versuchen Sie es erneut.",
		authFailed: "Authentifizierung fehlgeschlagen. Bitte überprüfen Sie Ihre Anmeldedaten.",
		templateNotFound: "Die angeforderte Vorlage konnte nicht gefunden werden. Bitte überprüfen Sie die Vorlagen-ID.",
	...
	aiChat: {
		...
		applyFailed: "Änderungen konnten nicht auf die Vorlage angewendet werden. Bitte versuchen Sie es erneut.",
		revert: "Änderungen rückgängig",
		reapply: "Änderungen erneut anwenden",
		error: "Vorlage konnte nicht generiert werden",
		clear: "Chat leeren",
		placeholder: "Beschreiben Sie die E-Mail-Vorlage, die Sie erstellen möchten, oder bitten Sie um Änderungen an der aktuellen.",
	...
	scoring: {
		...
		emptyState: "Bewerten Sie Ihre Vorlage, um umsetzbare Rückmeldungen zu Spam-Risiko, Lesbarkeit, Barrierefreiheit und Best Practices zu erhalten."
	},
	aiMenu: {
		aiAssistant: "KI-Assistent",
		aiAssistantDesc: "Mit KI chatten, um Ihre Vorlage zu erstellen oder zu ändern",
		...
		disclaimer: "KI kann Fehler machen. Bitte überprüfen Sie die Ergebnisse vor der Genehmigung."
	},
	comments: {
		title: "Kommentare",
		...
		noCommentsHint: "Starten Sie eine Konversation, indem Sie einen Kommentar zur Vorlage oder einem bestimmten Block hinzufügen.",
		...
		saveTemplateFirst: "Speichern Sie die Vorlage, bevor Sie diesen Block kommentieren.",
		button: "Kommentare"
	},
	collaboration: {
	...
	designReference: {
		...
		promptPlaceholder: "Beschreiben Sie Anpassungen oder Wünsche für die generierte Vorlage...",
		generate: "Aus Design generieren",
		generating: "Design wird analysiert und Vorlage generiert...",
		replaceWarning: "Die Generierung aus einer Designvorlage ersetzt den vorhandenen Vorlageninhalt.",
...
//# sourceMappingURL=de-uVoSP1xF.js.map