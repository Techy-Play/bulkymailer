...
//#region ../../node_modules/.pnpm/pusher-js@8.6.0/node_modules/pusher-js/dist/web/pusher.js
	...
	(function(n, r) {
		...
		var e = {
				...
				var r = 256, i = function() {
					...
					return e.prototype.encodedLength = function(e) {
						...
						if (i > 0) {
							...
							t += this._encodeByte(r >>> 18 & 63), t += this._encodeByte(r >>> 12 & 63), t += i === 2 ? this._encodeByte(r >>> 6 & 63) : this._paddingCharacter || "", t += this._paddingCharacter || "";
						}
						return t;
			...
			207(e, t, n) {
						...
						if (a.readyState === 4) if (a.status === 200) {
							...
							switch (r) {
								case d.UserAuthentication:
									...
									break;
								case d.ChannelAuthorization: e = `Clients must be authorized to join private or presence channels. ${u.buildLogSuffix("authorizationEndpoint")}`;
							}
				...
				}, ce = typeof window < "u" && window.btoa || function(e) {
				...
				function T(e, ...t) {
					for (var n = 0; n < t.length; n++) {
						var r = t[n];
						for (var i in r) i !== "__proto__" && i !== "constructor" && i !== "prototype" && (e[i] = r[i] && r[i].constructor && r[i].constructor === Object ? T(e[i] || {}, r[i]) : r[i]);
					}
					return e;
				}
				function me() {
				...
				function we(e) {
					return ve(e, function(e) {
						return e === null ? "" : (typeof e == "object" && (e = k(e)), encodeURIComponent(y(e.toString())));
					});
				}
				function Te(e) {
				...
				class qe extends P {
					...
					isOnline() {
						return window.navigator.onLine === void 0 || window.navigator.onLine;
					}
				}
				var Je = new qe();
				class Ye {
								...
								if (t !== void 0) {
									switch (A.debug("Event recd", t), t.event) {
										...
										case "pusher:ping":
											this.emit("ping");
											break;
										case "pusher:pong": this.emit("pong");
									}
									this.emit("message", t);
								}
							},
				...
				function st(e, t) {
					if (e.indexOf("private-encrypted-") === 0) {
						...
						let n = u.buildLogSuffix("encryptedChannelSupport");
						throw new m(`Tried to subscribe to a private-encrypted- channel but no nacl implementation available. ${n}`);
					}
					if (e.indexOf("private-") === 0) return V.createPrivateChannel(e, t);
					if (e.indexOf("presence-") === 0) return V.createPresenceChannel(e, t);
					if (e.indexOf("#") === 0) throw new te("Cannot create a channel with name \"" + e + "\".");
					return V.createChannel(e, t);
				}
				let V = {
					createChannels() {
						return new ot();
						...
						if (e.status === 200) {
							...
							switch (e.data.slice(0, 1)) {
								...
								case "h":
									...
									break;
								case "c": t = JSON.parse(e.data.slice(1) || "[]"), this.onClose(t[0], t[1], !0);
							}
						}
					}
					onOpen(e) {
						...
						return t.onreadystatechange = t.onprogress = function() {
							switch (t.readyState) {
								case 3:
									...
									break;
								case 4: t.responseText && t.responseText.length > 0 && e.onChunk(t.status, t.responseText), e.emit("finished", t.status), e.close();
							}
						}, t;
					},
					abortRequest: function(e) {
				...
				let Y = {
					...
					addUnloadListener(e) {
						window.addEventListener === void 0 ? window.attachEvent !== void 0 && window.attachEvent("onunload", e) : window.addEventListener("pagehide", e, !1);
					},
					removeUnloadListener(e) {
						window.addEventListener === void 0 ? window.detachEvent !== void 0 && window.detachEvent("onunload", e) : window.removeEventListener("pagehide", e, !1);
					},
					randomInt(e) {
						let t = window.crypto || window.msCrypto, n = Math.floor(2 ** 32 / e) * e, r;
						do
							r = t.getRandomValues(/* @__PURE__ */ new Uint32Array(1))[0];
						while (r >= n);
						return r % e;
					}
				};
				...
				function Zt(e) {
					return Y.getProtocol() === "https:" || e.forceTLS !== !1;
				}
				function Qt(e) {
				...
				function tn(e, t) {
					let n;
					return "channelAuthorization" in e ? n = Object.assign(Object.assign({}, a.channelAuthorization), e.channelAuthorization) : (n = {
						transport: e.authTransport || a.authTransport,
						endpoint: e.authEndpoint || a.authEndpoint
					}, "auth" in e && ("params" in e.auth && (n.params = e.auth.params), "headers" in e.auth && (n.headers = e.auth.headers)), "authorizer" in e && (n.customHandler = Kt(t, n, e.authorizer))), n;
				}
				function nn(e, t) {
					let n = tn(e, t);
				...
				class sn extends P {
					constructor(e) {
						super(function(e, t) {
							...
							if (e) {
								A.warn(`Error during signin: ${e}`), this.emit("pusher:signin_error", Object.assign({}, {
									type: "AuthError",
									error: e.message
								}, e instanceof _ ? { status: e.status } : {})), this._cleanup();
								return;
							}
...
//# sourceMappingURL=pusher-kUlkqMvR.js.map