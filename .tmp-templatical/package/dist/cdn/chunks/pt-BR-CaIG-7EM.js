...
var e = {
	...
	blockActions: {
		...
		dragLifted: "Movendo {block}. Use as setas para cima e para baixo para reposicionar, Espaço ou Enter para soltar, Escape para cancelar.",
	...
	image: {
		...
		placeholderUrlTooltip: "Como a URL da imagem usa uma merge tag, você pode fornecer uma imagem real aqui para visualizar o layout durante o design. Isso não é incluído na saída final.",
		...
		decorativeHint: "Oculta para leitores de tela. Use apenas para espaçadores e elementos visuais."
	},
	video: {
		...
		placeholderUrlPlaceholder: "https://... (somente em design)",
		placeholderUrlTooltip: "Como a URL do vídeo usa uma merge tag, você pode fornecer uma miniatura real aqui para visualizar o layout durante o design. Isso não é incluído na saída final.",
	...
	customBlocks: {
		definitionNotFound: "Tipo de bloco desconhecido — este bloco não está registrado",
		renderError: "Este bloco não pôde ser renderizado. Verifique se há erros no template do bloco.",
		fields: {
		...
		toolbar: { noDefinition: "Registre este tipo de bloco na sua configuração do SDK para editar suas propriedades" },
		dataSource: {
	...
	html: {
		...
		sanitizationHint: "O HTML é exportado como está e não é sanitizado — garanta que o conteúdo seja seguro."
	},
	blockSettings: {
		spacing: "Espaçamento",
	...
	templateSettings: {
		...
		preheaderTextPlaceholder: "Texto de prévia exibido após o assunto na caixa de entrada...",
		preheaderTextHint: "Este texto aparece após o assunto nas pré-visualizações dos clientes de e-mail. Suporta merge tags.",
		language: "Idioma",
		contentLocale: "Idioma do conteúdo",
		contentLocaleHint: "Código BCP 47 (ex.: en, de, pt-BR). Define o atributo lang do e-mail renderizado para que leitores de tela pronunciem o conteúdo corretamente.",
		tips: "Dicas",
	...
	canvas: {
		...
		aiHintDesign: "Tem um design existente? Envie uma captura de tela, imagem ou PDF e a",
	...
	mediaLibrary: {
		...
		deleteWarningMessage: "Este arquivo será excluído permanentemente e não poderá ser recuperado.",
	...
	previewResolution: {
		...
		failed: "Não foi possível resolver a pré-visualização — exibindo o modelo não resolvido.",
	...
	testEmail: {
		...
		previewHint: "As merge tags aparecem sem resolução — seu backend as preenche.",
		previewHintSample: "As merge tags mostram valores de exemplo — seu backend insere os dados reais.",
		recipientNotAllowed: "Esse endereço não está na lista de destinatários permitidos.",
		send: "Enviar",
		sending: "Enviando...",
		cancel: "Cancelar",
	...
	smallScreen: {
		...
		message: "O editor precisa de mais espaço do que esta tela oferece. Abra-o em um tablet ou desktop para começar a editar."
	}
};
//#endregion
export { e as default };

//# sourceMappingURL=pt-BR-CaIG-7EM.js.map