...
var e = {
	...
	sidebar: {
		...
		noSelectionHint: "Wählen Sie einen Block auf der Leinwand aus, um ihn zu bearbeiten"
	},
	toolbar: {
	...
	customBlocks: {
		...
		renderError: "Dieser Block konnte nicht gerendert werden. Überprüfen Sie die Block-Vorlage auf Fehler.",
		fields: {
		...
		toolbar: { noDefinition: "Registrieren Sie diesen Blocktyp in Ihrer SDK-Konfiguration, um seine Eigenschaften zu bearbeiten" },
		dataSource: {
	...
	html: {
		...
		sanitizationHint: "HTML wird unverändert exportiert und nicht bereinigt – stellen Sie sicher, dass der Inhalt sicher ist."
	},
	blockSettings: {
		spacing: "Abstände",
	...
	canvas: {
		...
		dragHint: "Beginnen Sie von Grund auf, indem Sie Blöcke aus der Seitenleiste ziehen",
		dropHere: "Hier ablegen",
		aiHintChat: "oder lassen Sie",
		aiHintChatSuffix: "in Sekunden eine komplette Vorlage für Sie erstellen",
		aiHintDesign: "Haben Sie ein bestehendes Design? Laden Sie einen Screenshot, ein Bild oder PDF hoch und",
	...
	mediaLibrary: {
		...
		deleteWarningMessage: "Diese Datei wird dauerhaft gelöscht und kann nicht wiederhergestellt werden.",
	...
	savedBlocks: {
		...
		emptyHint: "Speichern Sie Blöcke aus Ihren Vorlagen, um sie später wiederzuverwenden.",
		...
		reorderHint: "Zum Umsortieren ziehen — in dieser Reihenfolge werden die Blöcke gespeichert",
		reorderHandle: "{block} umsortieren, Position {position} von {total}",
		reorderAnnouncement: "{block} an Position {position} von {total} verschoben",
		expand: "Aufklappen",
		collapse: "Zuklappen",
	...
	previewResolution: {
		...
		failed: "Die Vorschau konnte nicht aufgelöst werden — die unaufgelöste Vorlage wird angezeigt.",
	...
	testEmail: {
		...
		preview: "Vorschau",
		previewHint: "Merge-Tags werden unaufgelöst angezeigt — Ihr Backend setzt sie ein.",
		previewHintSample: "Merge-Tags zeigen Beispielwerte — Ihr Backend setzt die echten Daten ein.",
		recipientNotAllowed: "Diese Adresse steht nicht auf der Liste der erlaubten Empfänger.",
		send: "Senden",
	...
	smallScreen: {
		...
		message: "Der Editor benötigt mehr Platz, als dieser Bildschirm bietet. Öffnen Sie ihn auf einem Tablet oder Desktop, um mit der Bearbeitung zu beginnen."
	}
};
//#endregion
export { e as default };

//# sourceMappingURL=de-DHra3lvx.js.map